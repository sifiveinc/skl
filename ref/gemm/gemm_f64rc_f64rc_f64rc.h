 ...
 */
void skl_gemm_f64rc_f64rc_f64rc_ref(size_t m, size_t n, size_t k, double alpha,
                                    const double *a, size_t rsa, size_t csa,
                                    const double *b, size_t rsb, size_t csb,
                                    double beta, double *c, size_t rsc,
                                    size_t csc);
