...
/**
 * @brief Reference BF16 logistic: out = logistic(x).
 *
...
/**
 * @brief Reference BF16 SiLU: out = x * logistic(x).
 *
 * Convenience wrapper around skl_sigmoid_bf16_ref.
 */
...
/**
 * @brief Reference BF16 Swish: out = x * logistic(beta * x).
 *
...
/**
 * @brief Reference BF16 GLU: out = x * logistic(y).
 *
 * Convenience wrapper around skl_sigmoid_bf16_ref.
 */
