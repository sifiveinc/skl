...
/**
 * @brief Reference FP32 sigmoid with optional fused multiplications.
 *
 ...
 * Convenience wrapper around skl_sigmoid_f32_ref.
 */
void skl_glu_f32_ref(float *out, const float *x, const float *y, size_t n);

/**
 * @brief Reference FP32 SwiGLU: out = silu(gate) * (up + delta).
 *
 * Convenience wrapper around skl_sigmoid_f32_ref.
 */
void skl_swiglu_f32_ref(float *out, const float *gate, const float *up,
