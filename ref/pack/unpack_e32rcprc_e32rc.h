...
/**
 * @brief Reference implementation for unpacking an 32-bit 4D blocked matrix
 * into a 2D matrix.
 *
 ...
 */
void skl_unpack_e32rcprc_e32rc_ref(size_t m0, size_t n0,
                                   const uint32_t *SKL_RESTRICT src, size_t rs0,
                                   size_t cs0, size_t rs1, size_t cs1, size_t m,
                                   size_t n, uint32_t *SKL_RESTRICT dst,
                                   size_t rs, size_t cs);
