...
- `SKL_ENABLE_VERIFICATION`: Includes correctness verification against reference implementation
- `SKL_ENABLE_PROFILING`: Includes performance measurement using cycle counters
