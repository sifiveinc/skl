...
/**
 * @brief xsfvfexpa_zvfh-based FP16 logistic: out = sigmoid(x).
 *
...
/**
 * @brief xsfvfexpa_zvfh-based FP16 SiLU: out = x * sigmoid(x).
 *
 * Convenience wrapper around skl_sigmoid_f16_xsfvfexpa_zvfh.
 */
...
/**
 * @brief xsfvfexpa_zvfh-based FP16 Swish: out = x * sigmoid(beta * x).
 *
...
/**
 * @brief xsfvfexpa_zvfh-based FP16 GLU: out = x * sigmoid(y).
 *
 * Convenience wrapper around skl_sigmoid_f16_xsfvfexpa_zvfh.
 */
