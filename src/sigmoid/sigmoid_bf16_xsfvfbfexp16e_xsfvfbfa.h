...
/**
 * @brief Xsfvfbfexp16e/Xsfvfbfa-based BF16 sigmoid with optional
 *        fused multiplications.
 *
 ...
 */
void skl_logistic_bf16_xsfvfbfexp16e_xsfvfbfa(__bf16 *out, const __bf16 *x,
                                              size_t n);
 ...
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfbfexp16e_xsfvfbfa.
 */
void skl_silu_bf16_xsfvfbfexp16e_xsfvfbfa(__bf16 *out, const __bf16 *x,
                                          size_t n);
 ...
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfbfexp16e_xsfvfbfa.
 */
void skl_swish_bf16_xsfvfbfexp16e_xsfvfbfa(__bf16 *out, __bf16 beta,
 ...
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfbfexp16e_xsfvfbfa.
 */
void skl_glu_bf16_xsfvfbfexp16e_xsfvfbfa(__bf16 *out, const __bf16 *x,
                                         const __bf16 *y, size_t n);

/**
 * @brief xsfvfbfexp16e_xsfvfbfa-based BF16 SwiGLU: out = silu(gate) * (up +
 * delta).
 *
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfbfexp16e_xsfvfbfa.
 */
void skl_swiglu_bf16_xsfvfbfexp16e_xsfvfbfa(__bf16 *out, const __bf16 *gate,
                                            const __bf16 *up, __bf16 delta,
                                            size_t n);
