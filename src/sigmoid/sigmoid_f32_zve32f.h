...
/**
 * @brief zve32f-based FP32 logistic: out = sigmoid(x).
 *
...
/**
 * @brief zve32f-based FP32 SiLU: out = x * sigmoid(x).
 *
 * Convenience wrapper around skl_sigmoid_f32_zve32f.
 */
...
/**
 * @brief zve32f-based FP32 Swish: out = x * sigmoid(beta * x).
 *
...
/**
 * @brief zve32f-based FP32 GLU: out = x * sigmoid(y).
 *
 * Convenience wrapper around skl_sigmoid_f32_zve32f.
 */
