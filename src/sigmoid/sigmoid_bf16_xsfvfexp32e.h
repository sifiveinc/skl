...
/**
 * @brief xsfvfexp32e-based BF16 logistic: out = logistic(x).
 *
...
/**
 * @brief xsfvfexp32e-based BF16 SiLU: out = x * logistic(x).
 *
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfexp32e.
 */
...
/**
 * @brief xsfvfexp32e-based BF16 Swish: out = x * logistic(beta * x).
 *
...
/**
 * @brief xsfvfexp32e-based BF16 GLU: out = x * logistic(y).
 *
 * Convenience wrapper around skl_sigmoid_bf16_xsfvfexp32e.
 */
