...
skl_logistic_2u_bf16_xsfvfexp32e_vfwcvt_f_x_v_f32m8(vint16m4_t i, size_t vl) {
...
skl_logistic_2u_bf16_xsfvfexp32e_vfncvt_x_f_w_bf16m4(vfloat32m8_t X,
                                                     size_t vl) {
#if defined(__riscv_zvfbfmin)
...
SKL_FUNC void skl_logistic_2u_bf16_xsfvfexp32e(__bf16 *out, const __bf16 *in,
                                               size_t n) {
  size_t vl;
  for (size_t i = 0; i < n; i += vl) {
    ...
    vfloat32m8_t a = skl_logistic_2u_bf16_xsfvfexp32e_vfwcvt_f_x_v_f32m8(x, vl);
    ...
    /* 3. Quotient, Narrow, & Store */
    vfloat32m8_t q = __riscv_vfmul_vv_f32m8_mu(m, r, r, e, vl);
    vint16m4_t b = skl_logistic_2u_bf16_xsfvfexp32e_vfncvt_x_f_w_bf16m4(q, vl);
