...
/**
 * @brief 1-ULP BFloat16 exponential function using Xsfvfexpa.
 *
 ...
 *
 * Results are accurate to less than 0.511 ulp.
 */
void skl_exp_1u_bf16_xsfvfexpa_zvfbfmin(__bf16 *out, const __bf16 *in,
                                        size_t n);
