...
SKL_FUNC_PRIVATE void skl_gemm_6xm4_i8rcp_i8pc_i32_xsfvqdotq(
  ...
  if (k >= 4) {
    skl_memcpy_zve32x(&a0_0, a0, 4);
    a0 += csa1;
    skl_memcpy_zve32x(&a0_1, a1, 4);
    a1 += csa1;
    skl_memcpy_zve32x(&a0_2, a2, 4);
    a2 += csa1;
    skl_memcpy_zve32x(&a0_3, a3, 4);
    a3 += csa1;
    skl_memcpy_zve32x(&a0_4, a4, 4);
    a4 += csa1;
    skl_memcpy_zve32x(&a0_5, a5, 4);
    a5 += csa1;
    ...
    while (k >= 12) {
      ...
      skl_memcpy_zve32x(&a1_0, a0, 4);
      a0 += csa1;
      skl_memcpy_zve32x(&a1_1, a1, 4);
      a1 += csa1;
      skl_memcpy_zve32x(&a1_2, a2, 4);
      a2 += csa1;
      skl_memcpy_zve32x(&a1_3, a3, 4);
      a3 += csa1;
      skl_memcpy_zve32x(&a1_4, a4, 4);
      a4 += csa1;
      skl_memcpy_zve32x(&a1_5, a5, 4);
      a5 += csa1;
  ...
  if (k) {
    ...
    skl_memcpy_zve32x(&a0_0, a0, k);
    skl_memcpy_zve32x(&a0_1, a1, k);
    skl_memcpy_zve32x(&a0_2, a2, k);
    skl_memcpy_zve32x(&a0_3, a3, k);
    skl_memcpy_zve32x(&a0_4, a4, k);
    skl_memcpy_zve32x(&a0_5, a5, k);
...
SKL_FUNC_PRIVATE void skl_gemm_1xm4_i8rcp_i8pc_i32_xsfvqdotq(
  ...
  while (k >= 16) {
    // load 4 words from A
    skl_memcpy_zve32x(&a0, a_pack, 4);
    a_pack += csa1;
    skl_memcpy_zve32x(&a1, a_pack, 4);
    a_pack += csa1;
    skl_memcpy_zve32x(&a2, a_pack, 4);
    a_pack += csa1;
    skl_memcpy_zve32x(&a3, a_pack, 4);
    a_pack += csa1;
