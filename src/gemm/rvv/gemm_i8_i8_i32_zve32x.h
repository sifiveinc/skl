...
#error This file requires the RISC-V Zve32x extension.
#endif
 ...
 * ```
 */
void skl_gemm_i8_i8_i32_zve32x(size_t m, size_t n, size_t k, int32_t alpha,
                               const int8_t *a, size_t rsa, const int8_t *b,
                               size_t rsb, int32_t beta, int32_t *c,
                               size_t rsc);
