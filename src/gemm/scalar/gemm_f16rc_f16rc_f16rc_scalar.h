...
/**
 * @brief Scalar float16 matrix-matrix multiplication (HGEMM).
 *
 ...
 */
void skl_gemm_f16rc_f16rc_f16rc_scalar(size_t m, size_t n, size_t k,
                                       _Float16 alpha, const _Float16 *a,
                                       size_t rsa, size_t csa,
                                       const _Float16 *b, size_t rsb,
                                       size_t csb, _Float16 beta, _Float16 *c,
