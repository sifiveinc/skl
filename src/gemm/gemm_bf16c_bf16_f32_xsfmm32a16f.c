...
void skl_gemm_tile_zero_bf16_f32_xsfmmbase(size_t m, size_t n, size_t tss,
  ...
  skl_gemm_tile_zero_bf16_f32_xsfmmbase_t tile_zero_functions[] = {
      &skl_gemm_tile_zero_mt0_bf16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt4_bf16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt8_bf16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt12_bf16_f32_xsfmmbase,
  };
 ...
 */
SKL_FUNC_PRIVATE
void skl_gemm_apply_fused_bf16_f32_f32rcptexterc_xsfmmbase(
...
void skl_gemm_alpha_beta_scaling_bf16_f32_f32rcptexterc_xsfmmbase(
  ...
  if (ete <= (size_t)__riscv_vsetvlmax_e32m2() && csc0 == 1) {
    skl_gemm_alpha_beta_scaling_m2_bf16_f32_f32_xsfmmbase(tm, tn, alpha, tss,
                                                          beta, c_block, rsc0);
  } else {
    skl_gemm_alpha_beta_scaling_m8_bf16_f32_f32rc_xsfmmbase(
...
skl_gemm_inner_loop_1x1_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f(
  ...
  const __bf16 *a0 = a;
  const __bf16 *a1 = a0 + csa1;
  const __bf16 *b0 = b;
  const __bf16 *b1 = b0 + rsb1;
  __asm__ volatile("beqz %[k], 2f\n"

                   "sf.vsettnt x0, %[n], e16alt, w2\n"
                   "sf.vsettm x0, %[m]\n"
                   "sf.vsettk x0, %[k]\n"
                   ...
                   : [a0] "+&r"(a0), [a1] "+&r"(a1), [b0] "+&r"(b0),
                     [b1] "+&r"(b1), [k] "+&r"(k)
                   : [csa1] "r"(2 * csa1 * sizeof(__bf16)),
                     [rsb1] "r"(2 * rsb1 * sizeof(__bf16)), [m] "r"(m),
                     [n] "r"(n), [i2] "r"(2)
...
skl_gemm_inner_loop_1x2_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f(
  ...
  const __bf16 *a0_0 = a;
  const __bf16 *a0_1 = a0_0 + csa1;
  const __bf16 *b0_0 = b;
  const __bf16 *b0_1 = b0_0 + rsb1;
  const __bf16 *b1_0 = b0_0 + csb1;
  const __bf16 *b1_1 = b1_0 + rsb1;
  if (k < 2) {
    __asm__ volatile("beqz %[k], 0f\n"
                     ...
                     : [a0_0] "r"(a0_0), [b0_0] "r"(b0_0), [b1_0] "r"(b1_0),
                       [m] "r"(m), [tn0] "r"(tn0), [tn1] "r"(tn1), [k] "r"(k)
...
skl_gemm_inner_loop_1x3_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f(
  ...
  if (k < 2) {
    __asm__ volatile("beqz %[k], 0f\n"
                     ...
                     :
                     : [a0_0] "r"(a0_0), [b0_0] "r"(b0_0), [b1_0] "r"(b1_0),
                       [b2_0] "r"(b2_0), [m] "r"(m), [tn0] "r"(tn0),
                       [tn1] "r"(tn1), [tn2] "r"(tn2), [k] "r"(k)
                     : "v0", "v1", "v2", "v3", "v8", "v9", "v10", "v11", "v16",
    ...
    __asm__ volatile(
        ...
        : [csa1] "r"(2 * csa1 * sizeof(__bf16)),
          [rsb1] "r"(2 * rsb1 * sizeof(__bf16)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [i4] "r"(4)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
          "v31", "vtype", "vl", "memory");
...
skl_gemm_inner_loop_1x4_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f(
  ...
  if (k < 2) {
    __asm__ volatile(
        ...
        :
        : [a0_0] "r"(a0_0), [b0_0] "r"(b0_0), [b1_0] "r"(b1_0),
          [b2_0] "r"(b2_0), [b3_0] "r"(b3_0), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [tn3] "r"(tn3), [k] "r"(k)
    ...
    __asm__ volatile(
        ...
        : [csa1] "r"(2 * csa1 * sizeof(__bf16)),
          [rsb1] "r"(2 * rsb1 * sizeof(__bf16)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [tn3] "r"(tn3), [i4] "r"(4)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
  ...
  if (k < 2) {
    __asm__ volatile("beqz %[k], 0f\n"
                     ...
                     : [a0_0] "r"(a0_0), [a1_0] "r"(a1_0), [b0_0] "r"(b0_0),
                       [b1_0] "r"(b1_0), [tm0] "r"(tm0), [tm1] "r"(tm1),
                       [tn0] "r"(tn0), [tn1] "r"(tn1), [k] "r"(k)
                     : "v0", "v1", "v2", "v3", "v8", "v9", "v10", "v11", "v16",
                       "v17", "v18", "v19", "v24", "v25", "v26", "v27", "vtype",
                       "vl", "memory");
  } else {
    __asm__ volatile(
        ...
        : [a0_0] "+&r"(a0_0), [a0_1] "+&r"(a0_1), [a1_0] "+&r"(a1_0),
          ...
          [b1_0] "+&r"(b1_0), [b1_1] "+&r"(b1_1), [k] "+&r"(k)
        : [csa1] "r"(2 * csa1 * sizeof(__bf16)),
          [rsb1] "r"(2 * rsb1 * sizeof(__bf16)), [tm0] "r"(tm0), [tm1] "r"(tm1),
          [tn0] "r"(tn0), [tn1] "r"(tn1), [i4] "r"(4)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_apply_tiling_bf16rcptex1c_bf16rcp1xte_f32_f32rcptexterc_xsfmm32a16f(
    size_t m1, size_t n1,
    skl_gemm_inner_loop_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f_t inner_loop,
    size_t m, size_t n, size_t k, const __bf16 *a, size_t rsa1, size_t csa1,
  ...
  if (accum) {
    skl_gemm_tile_load_bf16_f32rcptexterc_f32_xsfmmbase(
        m, n, c + row1 * rsc1 + col1 * csc1, rsc0, csc0, rsc1, csc1,
        trans ? mt0c : mt0, rstss, cstss);
  } else {
    if (trans) {
      // NOLINTBEGIN(readability-suspicious-call-argument)
      skl_gemm_tile_zero_bf16_f32_xsfmmbase(n, m, mt0, cstss, rstss);
      // NOLINTEND(readability-suspicious-call-argument)
    } else {
      skl_gemm_tile_zero_bf16_f32_xsfmmbase(m, n, mt0, rstss, cstss);
    }
  }
  ...
  skl_gemm_apply_fused_bf16_f32_f32rcptexterc_xsfmmbase(
...
#define SKL_GEMM_TILE(M1, N1, M1XN1, M, N, ROW1, COL1)                            \
  do {                                                                            \
    skl_gemm_apply_tiling_bf16rcptex1c_bf16rcp1xte_f32_f32rcptexterc_xsfmm32a16f( \
        M1, N1,                                                                   \
        skl_gemm_inner_loop_##M1XN1##_bf16rcptex1c_bf16rcp1xte_f32_xsfmm32a16f,   \
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_fused_bf16rcptex1c_bf16rcp1xte_f32rcptexterc_xsfmm32a16f(
    size_t m, size_t n, size_t k, const __bf16 *a, size_t rsa1, size_t csa1,
    const __bf16 *b, size_t rsb1, size_t csb1, float *c, size_t rsc0,
...
SKL_FUNC void skl_gemm_bf16c_bf16_f32_xsfmm32a16f(size_t m, size_t n, size_t k,
                                                  float alpha, const __bf16 *a,
                                                  size_t csa, const __bf16 *b,
                                                  size_t rsb, float beta,
                                                  float *c, size_t rsc) {
  skl_gemm_alpha_beta_scaling_params_bf16_f32_f32rcptexterc_xsfmmbase_t params =
  ...
  skl_gemm_fused_bf16rcptex1c_bf16rcp1xte_f32rcptexterc_xsfmm32a16f(
      ...
      skl_gemm_alpha_beta_scaling_bf16_f32_f32rcptexterc_xsfmmbase, &params);
}

/* Computes C = alpha * A * B + beta * C for packed matrices A, B, and C. */
SKL_FUNC void skl_gemm_bf16rcptex1c_bf16rcp1xte_f32rcptexterc_xsfmm32a16f(
    size_t m1, size_t n1, size_t k, float alpha, const __bf16 *a, size_t rsa1,
    size_t csa1, const __bf16 *b, size_t rsb1, size_t csb1, float beta,
  ...
  skl_gemm_fused_bf16rcptex1c_bf16rcp1xte_f32rcptexterc_xsfmm32a16f(
      ...
      csc1, false, skl_gemm_alpha_beta_scaling_bf16_f32_f32rcptexterc_xsfmmbase,
      &params);
}
