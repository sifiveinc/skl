...
skl_gemm_inner_loop_m1xn1_<a type>rcptex1c_<b type>rcp1xte_<accum type>_<isa>(
    size_t m, size_t n, size_t k, const <a type> *a, size_t rsa1, size_t csa1,
    const <b type> *b, size_t rsb1, size_t csb1) __riscv_inout("xsfmm");
```
...
```
SKL_FUNC_PRIVATE
void skl_gemm_tile_zero_<a/b type>_<accum type>_xsfmmbase(size_t m, size_t n,
                                                          size_t tss,
                                                          size_t rstss,
                                                          size_t cstss)
    __riscv_out("xsfmm");
