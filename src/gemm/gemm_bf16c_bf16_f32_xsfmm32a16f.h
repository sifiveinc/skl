...
/**
 * @brief Xsfmm widening bfloat16 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for bfloat16 column-major matrix A,
 * bfloat16 row-major matrix B, and float32 row-major matrix C.
 *
 ...
 * as `csa`.
 **/
void skl_gemm_bf16c_bf16_f32_xsfmm32a16f(size_t m, size_t n, size_t k,
...
/**
 * @brief Xsfmm packed widening bfloat16 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for packed bfloat16 matrices A and B,
 ...
 * ```
 */
void skl_gemm_bf16rcptex1c_bf16rcp1xte_f32rcptexterc_xsfmm32a16f(
