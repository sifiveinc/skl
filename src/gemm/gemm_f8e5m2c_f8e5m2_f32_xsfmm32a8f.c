...
void skl_gemm_tile_zero_f8e5m2_f32_xsfmmbase(size_t m, size_t n, size_t tss,
  ...
  skl_gemm_tile_zero_f8e5m2_f32_xsfmmbase_t tile_zero_functions[] = {
      &skl_gemm_tile_zero_mt0_f8e5m2_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt4_f8e5m2_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt8_f8e5m2_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt12_f8e5m2_f32_xsfmmbase,
  };
 ...
 */
SKL_FUNC_PRIVATE
void skl_gemm_apply_fused_f8e5m2_f32_f32rcptexterc_xsfmmbase(
...
void skl_gemm_alpha_beta_scaling_f8e5m2_f32_f32rcptexterc_xsfmmbase(
  ...
  if (ete <= (size_t)__riscv_vsetvlmax_e32m2() && csc0 == 1) {
    skl_gemm_alpha_beta_scaling_m2_f8e5m2_f32_f32_xsfmmbase(
        tm, tn, alpha, tss, beta, c_block, rsc0);
  } else {
    skl_gemm_alpha_beta_scaling_m8_f8e5m2_f32_f32rc_xsfmmbase(
...
skl_gemm_inner_loop_1x1_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_xsfmm32a8f(
  ...
  const uint8_t *a0_1 = a0_0 + csa1;
  const uint8_t *b0_0 = b;
  const uint8_t *b0_1 = b0_0 + rsb1;
  __asm__ volatile("beqz %[k], 4f\n"
                   ...
                   : [a0_0] "+&r"(a0_0), [a0_1] "+&r"(a0_1), [b0_0] "+&r"(b0_0),
                     [b0_1] "+&r"(b0_1), [k] "+&r"(k)
                   : [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
                     [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [m] "r"(m),
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        : [a0_1] "r"(a0_1), [b0_1] "r"(b0_1), [b1_1] "r"(b1_1),
          [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [m] "r"(m), [tn0] "r"(tn0),
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        : [a0_0] "+&r"(a0_0), [b0_0] "+&r"(b0_0), [b1_0] "+&r"(b1_0),
          [b2_0] "+&r"(b2_0)
        : [a0_1] "r"(a0_1), [b0_1] "r"(b0_1), [b1_1] "r"(b1_1),
          [b2_1] "r"(b2_1), [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [m] "r"(m), [tn0] "r"(tn0),
...
skl_gemm_inner_loop_1x4_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_xsfmm32a8f(
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        [b3_1] "r"(b3_1), [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
        [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [m] "r"(m), [tn0] "r"(tn0),
...
skl_gemm_inner_loop_2x2_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_xsfmm32a8f(
  ...
  const uint8_t *a0_0 = a;
  const uint8_t *a0_1 = a0_0 + csa1;
  const uint8_t *a1_0 = a0_0 + rsa1;
  const uint8_t *a1_1 = a1_0 + csa1;
  const uint8_t *b0_0 = b;
  const uint8_t *b0_1 = b0_0 + rsb1;
  const uint8_t *b1_0 = b0_0 + csb1;
  const uint8_t *b1_1 = b1_0 + rsb1;
  if (k < 4) {
    __asm__ volatile("beqz %[k], 2f\n"
                     ...
                     "sf.vsettm x0, %[tm1]\n"
                     "sf.vsettn x0, %[tn0]\n"
                     "sf.mm.e5m2.e5m2 mt8, v8, v16\n"
                     "sf.vsettn x0, %[tn1]\n"
                     "sf.mm.e5m2.e5m2 mt12, v8, v24\n"
                     "j 2f\n"
                     ...
                     : [a0_1] "r"(a0_1), [a1_1] "r"(a1_1), [b0_1] "r"(b0_1),
                       [b1_1] "r"(b1_1), [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
                       [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [tm0] "r"(tm0),
                       [tm1] "r"(tm1), [tn0] "r"(tn0), [tn1] "r"(tn1),
                       [k] "r"(k), [i1] "r"(1), [i2] "r"(2)
...
#pragma clang diagnostic pop
        ...
        : [csa1] "r"(2 * csa1 * sizeof(uint8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(uint8_t)), [tm0] "r"(tm0),
          [tm1] "r"(tm1), [tn0] "r"(tn0), [tn1] "r"(tn1), [i1] "r"(1),
          [i2] "r"(2), [i8] "r"(8)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_apply_tiling_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_f32rcptexterc_xsfmm32a8f(
    size_t m1, size_t n1,
    skl_gemm_inner_loop_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_xsfmm32a8f_t
        inner_loop,
    size_t m, size_t n, size_t k, const uint8_t *a, size_t rsa1, size_t csa1,
  ...
  if (accum) {
    skl_gemm_tile_load_f8e5m2_f32rcptexterc_f32_xsfmmbase(
        m, n, c + row1 * rsc1 + col1 * csc1, rsc0, csc0, rsc1, csc1,
        trans ? mt0c : mt0, rstss, cstss);
  } else {
    if (trans) {
      // NOLINTBEGIN(readability-suspicious-call-argument)
      skl_gemm_tile_zero_f8e5m2_f32_xsfmmbase(n, m, mt0, cstss, rstss);
      // NOLINTEND(readability-suspicious-call-argument)
    } else {
      skl_gemm_tile_zero_f8e5m2_f32_xsfmmbase(m, n, mt0, rstss, cstss);
    }
  }
  ...
  skl_gemm_apply_fused_f8e5m2_f32_f32rcptexterc_xsfmmbase(
...
#define SKL_GEMM_TILE(M1, N1, M1XN1, M, N, ROW1, COL1)                               \
  do {                                                                               \
    skl_gemm_apply_tiling_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_f32rcptexterc_xsfmm32a8f( \
        M1, N1,                                                                      \
        skl_gemm_inner_loop_##M1XN1##_f8e5m2rcptex1c_f8e5m2rcp1xte_f32_xsfmm32a8f,   \
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_fused_f8e5m2rcptex1c_f8e5m2rcp1xte_f32rcptexterc_xsfmm32a8f(
    size_t m, size_t n, size_t k, const uint8_t *a, size_t rsa1, size_t csa1,
    const uint8_t *b, size_t rsb1, size_t csb1, float *c, size_t rsc0,
...
SKL_FUNC void skl_gemm_f8e5m2c_f8e5m2_f32_xsfmm32a8f(
    size_t m, size_t n, size_t k, float alpha, const uint8_t *a, size_t csa,
    const uint8_t *b, size_t rsb, float beta, float *c, size_t rsc) {
  skl_gemm_alpha_beta_scaling_params_f8e5m2_f32_f32rcptexterc_xsfmmbase_t
  ...
  skl_gemm_fused_f8e5m2rcptex1c_f8e5m2rcp1xte_f32rcptexterc_xsfmm32a8f(
      ...
      skl_gemm_alpha_beta_scaling_f8e5m2_f32_f32rcptexterc_xsfmmbase, &params);
}

/* Computes C = alpha * A * B + beta * C for packed matrices A, B, and C. */
SKL_FUNC void skl_gemm_f8e5m2rcptex1c_f8e5m2rcp1xte_f32rcptexterc_xsfmm32a8f(
    size_t m1, size_t n1, size_t k, float alpha, const uint8_t *a, size_t rsa1,
    size_t csa1, const uint8_t *b, size_t rsb1, size_t csb1, float beta,
