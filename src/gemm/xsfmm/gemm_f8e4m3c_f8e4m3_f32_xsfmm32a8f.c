...
void skl_gemm_tile_zero_f8e4m3_f32_xsfmmbase(size_t m, size_t n, size_t tss,
  ...
  skl_gemm_tile_zero_f8e4m3_f32_xsfmmbase_t tile_zero_functions[] = {
      &skl_gemm_tile_zero_mt0_f8e4m3_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt4_f8e4m3_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt8_f8e4m3_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt12_f8e4m3_f32_xsfmmbase,
  };
 ...
 */
SKL_FUNC_PRIVATE
void skl_gemm_apply_fused_f8e4m3_f32_f32rcptexterc_xsfmmbase(
...
void skl_gemm_alpha_beta_scaling_f8e4m3_f32_f32rcptexterc_xsfmmbase(
  ...
  if (ete <= (size_t)__riscv_vsetvlmax_e32m2() && csc0 == 1) {
    skl_gemm_alpha_beta_scaling_m2_f8e4m3_f32_f32_xsfmmbase(
        tm, tn, alpha, tss, beta, c_block, rsc0);
  } else {
    skl_gemm_alpha_beta_scaling_m8_f8e4m3_f32_f32rc_xsfmmbase(
...
skl_gemm_inner_loop_2x2_f8e4m3rcptex1c_f8e4m3rcp1xte_f32_xsfmm32a8f(
  ...
  if (k < 4) {
    __asm__ volatile("beqz %[k], 2f\n"
                     ...
                     "sf.vsettm x0, %[tm1]\n"
                     "sf.vsettn x0, %[tn0]\n"
                     "sf.mm.e4m3.e4m3 mt8, v8, v16\n"
                     "sf.vsettn x0, %[tn1]\n"
                     "sf.mm.e4m3.e4m3 mt12, v8, v24\n"
                     "j 2f\n"
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_apply_tiling_f8e4m3rcptex1c_f8e4m3rcp1xte_f32_f32rcptexterc_xsfmm32a8f(
    size_t m1, size_t n1,
    skl_gemm_inner_loop_f8e4m3rcptex1c_f8e4m3rcp1xte_f32_xsfmm32a8f_t
        inner_loop,
    size_t m, size_t n, size_t k, const uint8_t *a, size_t rsa1, size_t csa1,
  ...
  if (accum) {
    skl_gemm_tile_load_f8e4m3_f32rcptexterc_f32_xsfmmbase(
        m, n, c + row1 * rsc1 + col1 * csc1, rsc0, csc0, rsc1, csc1,
        trans ? mt0c : mt0, rstss, cstss);
  } else {
    if (trans) {
      // NOLINTBEGIN(readability-suspicious-call-argument)
      skl_gemm_tile_zero_f8e4m3_f32_xsfmmbase(n, m, mt0, cstss, rstss);
      // NOLINTEND(readability-suspicious-call-argument)
    } else {
      skl_gemm_tile_zero_f8e4m3_f32_xsfmmbase(m, n, mt0, rstss, cstss);
    }
  }
  ...
  skl_gemm_apply_fused_f8e4m3_f32_f32rcptexterc_xsfmmbase(
...
#define SKL_GEMM_TILE(M1, N1, M1XN1, M, N, ROW1, COL1)                               \
  do {                                                                               \
    skl_gemm_apply_tiling_f8e4m3rcptex1c_f8e4m3rcp1xte_f32_f32rcptexterc_xsfmm32a8f( \
        M1, N1,                                                                      \
        skl_gemm_inner_loop_##M1XN1##_f8e4m3rcptex1c_f8e4m3rcp1xte_f32_xsfmm32a8f,   \
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_fused_f8e4m3rcptex1c_f8e4m3rcp1xte_f32rcptexterc_xsfmm32a8f(
    size_t m, size_t n, size_t k, const uint8_t *a, size_t rsa1, size_t csa1,
    const uint8_t *b, size_t rsb1, size_t csb1, float *c, size_t rsc0,
...
SKL_FUNC void skl_gemm_f8e4m3c_f8e4m3_f32_xsfmm32a8f(
  ...
  skl_gemm_fused_f8e4m3rcptex1c_f8e4m3rcp1xte_f32rcptexterc_xsfmm32a8f(
      ...
      skl_gemm_alpha_beta_scaling_f8e4m3_f32_f32rcptexterc_xsfmmbase, &params);
}

/* Computes C = alpha * A * B + beta * C for packed matrices A, B, and C. */
SKL_FUNC void skl_gemm_f8e4m3rcptex1c_f8e4m3rcp1xte_f32rcptexterc_xsfmm32a8f(
