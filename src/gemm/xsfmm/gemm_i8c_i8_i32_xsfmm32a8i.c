...
void skl_gemm_tile_zero_i8_i32_xsfmmbase(size_t m, size_t n, size_t tss,
  ...
  skl_gemm_tile_zero_i8_i32_xsfmmbase_t tile_zero_functions[] = {
      &skl_gemm_tile_zero_mt0_i8_i32_xsfmmbase,
      &skl_gemm_tile_zero_mt4_i8_i32_xsfmmbase,
      &skl_gemm_tile_zero_mt8_i8_i32_xsfmmbase,
      &skl_gemm_tile_zero_mt12_i8_i32_xsfmmbase,
  };
...
void skl_gemm_tile_load_i8_i32rcptexterc_i32_xsfmmbase(
  ...
  for (size_t i1 = 0; i1 < m1; ++i1) {
    ...
    for (size_t j1 = 0; j1 < n1; ++j1) {
      ...
      const int32_t *c_block = c + i1 * rsc1 + j1 * csc1;
      size_t i0 = 0;
      if (csc0 == 1) {
        __asm__ volatile(
            ...
            : [kRowInc] "rI"(kRowInc), [rsc0] "r"(rsc0 * sizeof(int32_t)),
              [tm] "r"(tm), [tn] "r"(tn)
            : "vtype", "vl", "memory");
      } else {
        vint32m8_t cvec = __riscv_vundefined_i32m8();
        __asm__ volatile(
            "sf.vsettnt x0, %[tn], e32, w1\n"
            ...
            : [kRowInc] "rI"(kRowInc), [rsc0] "r"(rsc0 * sizeof(int32_t)),
              [csc0] "r"(csc0 * sizeof(int32_t)), [tm] "r"(tm), [tn] "r"(tn)
            : "vtype", "vl", "memory");
      }
      n_avl -= tn;
    }
 ...
 */
SKL_FUNC_PRIVATE
void skl_gemm_apply_fused_i8_i32_i32rcptexterc_xsfmmbase(
...
SKL_FUNC_PRIVATE void skl_gemm_alpha_beta_scaling_m8_i8_i32_i32rc_xsfmmbase(
  ...
  if (csc0 == 1) {
    __asm__ volatile(
        ...
        "add %[tss], %[tss], %[kRowInc]\n"
        "vle32.v v16, (%[c])\n"
        "vmul.vx v16, v16, %[beta]\n"
        "vmacc.vx v16, %[alpha], v0\n"
        "vse32.v v16, (%[c])\n"
        "add %[c], %[c], %[rsc0]\n"
        "addi %[i], %[i], -1\n"
        "bnez %[i], 0b"
        : [tss] "+&r"(tss), [c] "+&r"(c), [i] "+&r"(i)
        : [alpha] "r"(alpha), [beta] "r"(beta), [kRowInc] "rI"(kRowInc),
          [rsc0] "r"(rsc0 * sizeof(int32_t)), [tn] "r"(tn)
    ...
    __asm__ volatile(
        ...
        : [tss] "+&r"(tss), [c] "+&r"(c), [i] "+&r"(i)
        : [alpha] "r"(alpha), [beta] "r"(beta), [kRowInc] "rI"(kRowInc),
          [rsc0] "r"(rsc0 * sizeof(int32_t)),
          [csc0] "r"(csc0 * sizeof(int32_t)), [tn] "r"(tn)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v16", "v17", "v18",
          "v19", "v20", "v21", "v22", "v23", "vtype", "vl", "memory");
  }
}
...
SKL_FUNC_PRIVATE void skl_gemm_alpha_beta_scaling_m2_i8_i32_i32_xsfmmbase(
  ...
  int32_t *c_load_0 = c;
  int32_t *c_load_1 = c_load_0 + rsc0;
  int32_t *c_store_0 = c;
  int32_t *c_store_1 = c_store_0 + rsc0;
  ...
  __asm__ volatile(
      ...
      "add %[tss_1], %[tss_1], %[kRowInc]\n"
      "vmul.vx v18, v18, %[beta]\n"

      "sf.vtmv.v.t v12, %[tss_0]\n"
      "add %[tss_0], %[tss_0], %[kRowInc]\n"
      "vle32.v v24, (%[c_load_0])\n"
      "add %[c_load_0], %[c_load_0], %[sc]\n"
      "vmul.vx v20, v20, %[beta]\n"

      "sf.vtmv.v.t v14, %[tss_1]\n"
      "add %[tss_1], %[tss_1], %[kRowInc]\n"
      "vle32.v v26, (%[c_load_1])\n"
      "add %[c_load_1], %[c_load_1], %[sc]\n"
      "vmul.vx v22, v22, %[beta]\n"

      "vmacc.vx v16, %[alpha], v0\n"
      "addi %[i], %[i], -8\n"
      "vle32.v v28, (%[c_load_0])\n"
      "add %[c_load_0], %[c_load_0], %[sc]\n"
      "vmacc.vx v18, %[alpha], v2\n"

      "vmacc.vx v20, %[alpha], v4\n"
      "vle32.v v30, (%[c_load_1])\n"
      "add %[c_load_1], %[c_load_1], %[sc]\n"
      "vmacc.vx v22, %[alpha], v6\n"
      "bltu %[i], %[i8], 1f\n"
      ...
      "vle32.v v18, (%[c_load_1])\n"
      "add %[c_load_1], %[c_load_1], %[sc]\n"
      "vmul.vx v30, v30, %[beta]\n"

      "vmacc.vx v24, %[alpha], v8\n"
      "addi %[i], %[i], -8\n"
      "vle32.v v20, (%[c_load_0])\n"
      "add %[c_load_0], %[c_load_0], %[sc]\n"
      "vmacc.vx v26, %[alpha], v10\n"

      "vmacc.vx v28, %[alpha], v12\n"
      "vle32.v v22, (%[c_load_1])\n"
      "add %[c_load_1], %[c_load_1], %[sc]\n"
      "vmacc.vx v30, %[alpha], v14\n"
      ...
      : [alpha] "r"(alpha), [beta] "r"(beta), [kRowInc] "rI"(2 * kRowInc),
        [sc] "r"(2 * rsc0 * sizeof(int32_t)), [tn] "r"(tn), [i8] "r"(8)
  ...
  if (i >= 4) {
    __asm__ volatile(
        ...
        : [alpha] "r"(alpha), [beta] "r"(beta), [kRowInc] "rI"(2 * kRowInc),
          [sc] "r"(2 * rsc0 * sizeof(int32_t)), [tn] "r"(tn)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v16", "v17", "v18",
          "v19", "v20", "v21", "v22", "v23", "vtype", "vl", "memory");
    i -= 4;
  }
  ...
  if (i >= 1) {
    __asm__ volatile("sf.vsettnt x0, %[tn], e32, w1\n"
                     ...
                     : [tss_0] "r"(tss_0), [c_load_0] "r"(c_load_0),
                       [c_store_0] "r"(c_store_0), [alpha] "r"(alpha),
                       [beta] "r"(beta), [tn] "r"(tn)
...
void skl_gemm_alpha_beta_scaling_i8_i32_i32rcptexterc_xsfmmbase(
  ...
  skl_gemm_alpha_beta_scaling_params_i8_i32_i32rcptexterc_xsfmmbase_t
      *params_cast =
          (skl_gemm_alpha_beta_scaling_params_i8_i32_i32rcptexterc_xsfmmbase_t
               *)params;
  int32_t alpha = params_cast->alpha;
  int32_t beta = params_cast->beta;
  int32_t *c_block = c + row1 * rsc1 + col1 * csc1;

  size_t ete = 0;
  __asm__ volatile("sf.vsettnt %0, x0, e32, w1" : "=r"(ete) : : "vtype", "vl");

  if (ete <= (size_t)__riscv_vsetvlmax_e32m2() && csc0 == 1) {
    skl_gemm_alpha_beta_scaling_m2_i8_i32_i32_xsfmmbase(tm, tn, alpha, tss,
                                                        beta, c_block, rsc0);
  } else {
    skl_gemm_alpha_beta_scaling_m8_i8_i32_i32rc_xsfmmbase(
...
skl_gemm_inner_loop_1x1_i8rcptex1c_i8rcp1xte_i32_xsfmm32a8i(
  ...
  const int8_t *a0_0 = a;
  const int8_t *a0_1 = a0_0 + csa1;
  const int8_t *b0_0 = b;
  const int8_t *b0_1 = b0_0 + rsb1;
  __asm__ volatile("beqz %[k], 4f\n"

                   "sf.vsettnt x0, %[n], e8, w4\n"
                   "sf.vsettm x0, %[m]\n"
                   "sf.vsettk x0, %[k]\n"
                   ...
                   : [a0_0] "+&r"(a0_0), [a0_1] "+&r"(a0_1), [b0_0] "+&r"(b0_0),
                     [b0_1] "+&r"(b0_1), [k] "+&r"(k)
                   : [csa1] "r"(2 * csa1 * sizeof(int8_t)),
                     [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m),
                     [n] "r"(n), [i1] "r"(1), [i2] "r"(2), [i4] "r"(4)
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        : [a0_1] "r"(a0_1), [b0_1] "r"(b0_1), [b1_1] "r"(b1_1),
          [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [k] "r"(k), [i1] "r"(1), [i2] "r"(2)
    ...
    __asm__ volatile(
        ...
        : [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [i1] "r"(1), [i2] "r"(2), [i8] "r"(8)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        : [a0_0] "+&r"(a0_0), [b0_0] "+&r"(b0_0), [b1_0] "+&r"(b1_0),
          [b2_0] "+&r"(b2_0)
        : [a0_1] "r"(a0_1), [b0_1] "r"(b0_1), [b1_1] "r"(b1_1),
          [b2_1] "r"(b2_1), [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [k] "r"(k), [i1] "r"(1), [i2] "r"(2)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v8", "v9", "v10", "v11", "v12",
          "v13", "v16", "v17", "v18", "v19", "v20", "v21", "v24", "v25", "v26",
          "v27", "v28", "v29", "vtype", "vl", "memory");
  } else {
    __asm__ volatile(
...
#pragma clang diagnostic pop
        ...
        : [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [i1] "r"(1), [i2] "r"(2), [i8] "r"(8)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
          "v31", "vtype", "vl", "memory");
...
skl_gemm_inner_loop_1x4_i8rcptex1c_i8rcp1xte_i32_xsfmm32a8i(
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        :
        [a0_1] "r"(a0_1), [b0_1] "r"(b0_1), [b1_1] "r"(b1_1), [b2_1] "r"(b2_1),
        [b3_1] "r"(b3_1), [csa1] "r"(2 * csa1 * sizeof(int8_t)),
        [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
        [tn1] "r"(tn1), [tn2] "r"(tn2), [tn3] "r"(tn3), [k] "r"(k), [i1] "r"(1),
        [i2] "r"(2)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v8", "v9", "v10", "v11", "v12",
          "v13", "v16", "v17", "v18", "v19", "v20", "v21", "vtype", "vl",
          "memory");
...
#pragma clang diagnostic pop
        ...
        : [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [m] "r"(m), [tn0] "r"(tn0),
          [tn1] "r"(tn1), [tn2] "r"(tn2), [tn3] "r"(tn3), [i1] "r"(1),
          [i2] "r"(2), [i8] "r"(8)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "vtype", "vl", "memory");
  ...
  if (k < 4) {
    __asm__ volatile(
        ...
        : [a0_1] "r"(a0_1), [a1_1] "r"(a1_1), [b0_1] "r"(b0_1),
          [b1_1] "r"(b1_1), [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [tm0] "r"(tm0), [tm1] "r"(tm1),
          [tn0] "r"(tn0), [tn1] "r"(tn1), [k] "r"(k), [i1] "r"(1), [i2] "r"(2)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v8", "v9", "v10", "v11", "v12",
          "v13", "v16", "v17", "v18", "v19", "v20", "v21", "v24", "v25", "v26",
          "v27", "v28", "v29", "vtype", "vl", "memory");
  } else {
...
#pragma clang diagnostic pop
        ...
        : [csa1] "r"(2 * csa1 * sizeof(int8_t)),
          [rsb1] "r"(2 * rsb1 * sizeof(int8_t)), [tm0] "r"(tm0), [tm1] "r"(tm1),
          [tn0] "r"(tn0), [tn1] "r"(tn1), [i1] "r"(1), [i2] "r"(2), [i8] "r"(8)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
          "v31", "vtype", "vl", "memory");
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_apply_tiling_i8rcptex1c_i8rcp1xte_i32_i32rcptexterc_xsfmm32a8i(
    size_t m1, size_t n1,
    skl_gemm_inner_loop_i8rcptex1c_i8rcp1xte_i32_xsfmm32a8i_t inner_loop,
    size_t m, size_t n, size_t k, const int8_t *a, size_t rsa1, size_t csa1,
  ...
  if (accum) {
    skl_gemm_tile_load_i8_i32rcptexterc_i32_xsfmmbase(
        m, n, c + row1 * rsc1 + col1 * csc1, rsc0, csc0, rsc1, csc1,
        trans ? mt0c : mt0, rstss, cstss);
  } else {
    if (trans) {
      // NOLINTBEGIN(readability-suspicious-call-argument)
      skl_gemm_tile_zero_i8_i32_xsfmmbase(n, m, mt0, cstss, rstss);
      // NOLINTEND(readability-suspicious-call-argument)
    } else {
      skl_gemm_tile_zero_i8_i32_xsfmmbase(m, n, mt0, rstss, cstss);
    }
  }
  ...
  skl_gemm_apply_fused_i8_i32_i32rcptexterc_xsfmmbase(
...
#define SKL_GEMM_TILE(M1, N1, M1XN1, M, N, ROW1, COL1)                         \
  do {                                                                         \
    skl_gemm_apply_tiling_i8rcptex1c_i8rcp1xte_i32_i32rcptexterc_xsfmm32a8i(   \
        M1, N1,                                                                \
        skl_gemm_inner_loop_##M1XN1##_i8rcptex1c_i8rcp1xte_i32_xsfmm32a8i, M,  \
        N, k, a + (ROW1) * rsa1, rsa1, csa1, b + (COL1) * csb1, rsb1, csb1, c, \
        rsc0, csc0, rsc1, csc1, ROW1, COL1, accum, kernel, params);            \
  } while (0)
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_fused_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
    size_t m, size_t n, size_t k, const int8_t *a, size_t rsa1, size_t csa1,
    const int8_t *b, size_t rsb1, size_t csb1, int32_t *c, size_t rsc0,
...
SKL_FUNC void skl_gemm_i8c_i8_i32_xsfmm32a8i(size_t m, size_t n, size_t k,
                                             int32_t alpha, const int8_t *a,
                                             size_t csa, const int8_t *b,
                                             size_t rsb, int32_t beta,
                                             int32_t *c, size_t rsc) {
  skl_gemm_alpha_beta_scaling_params_i8_i32_i32rcptexterc_xsfmmbase_t params = {
  ...
  skl_gemm_fused_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
      ...
      skl_gemm_alpha_beta_scaling_i8_i32_i32rcptexterc_xsfmmbase, &params);
}

/* Computes C = alpha * A * B + beta * C for packed matrices A, B, and C. */
SKL_FUNC void skl_gemm_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
    size_t m1, size_t n1, size_t k, int32_t alpha, const int8_t *a, size_t rsa1,
    size_t csa1, const int8_t *b, size_t rsb1, size_t csb1, int32_t beta,
    int32_t *c, size_t rsc0, size_t csc0, size_t rsc1, size_t csc1) {
  skl_gemm_alpha_beta_scaling_params_i8_i32_i32rcptexterc_xsfmmbase_t params = {
      .alpha = alpha, .beta = beta};
  ...
  skl_gemm_fused_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
      ...
      csc1, false, skl_gemm_alpha_beta_scaling_i8_i32_i32rcptexterc_xsfmmbase,
      &params);
}
