...
/**
 * @brief Xsfmm quad-widening int8 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for int8 column-major matrix A,
 * int8 row-major matrix B, and int32 row-major matrix C.
 *
 ...
 * as `csa`.
 **/
void skl_gemm_i8c_i8_i32_xsfmm32a8i(size_t m, size_t n, size_t k, int32_t alpha,
                                    const int8_t *a, size_t csa,
                                    const int8_t *b, size_t rsb, int32_t beta,
                                    int32_t *c, size_t rsc);

/**
 * @brief Xsfmm packed quad-widening int8 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for packed int8 matrices A and
 * B, and packed int32 matrix C.
 *
 * Equivalent to calling:
 * ```
 ...
 * ```
 */
void skl_gemm_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
