...
/**
 * @brief Xsfmm int8 A * B matrix-matrix multiplication with int32 output for
 ...
 * as `csa`.
 **/
void skl_gemm_a1b01_i8c_i8_i32_xsfmm32a8i(size_t m, size_t n, size_t k,
                                          const int8_t *a, size_t csa,
                                          const int8_t *b, size_t rsb,
                                          int32_t *c, size_t rsc, bool accum);

/**
 * @brief Xsfmm int8 A * B packed matrix-matrix multiplication with int32
 * output.
 *
