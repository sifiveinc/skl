...
/**
 * @brief Xsfmm quad-widening OFP8 E4M3 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for OFP8 E4M3 column-major matrix A,
 * OFP8 E4M3 row-major matrix B, and float32 row-major matrix C.
 *
 ...
 * as `csa`.
 **/
void skl_gemm_f8e4m3c_f8e4m3_f32_xsfmm32a8f(size_t m, size_t n, size_t k,
...
/**
 * @brief Xsfmm packed quad-widening OFP8 E4M3 GEMM.
 *
 ...
 *
 * Computes `C = alpha * A * B + beta * C` for packed OFP8 E4M3 matrices A and
 ...
 * ```
 */
void skl_gemm_f8e4m3rcptex1c_f8e4m3rcp1xte_f32rcptexterc_xsfmm32a8f(
