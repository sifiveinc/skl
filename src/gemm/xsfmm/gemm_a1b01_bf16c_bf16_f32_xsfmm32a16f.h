...
/**
 * @brief Xsfmm bfloat16 A * B matrix-matrix multiplication with float32 output
 ...
 * as `csa`.
 **/
void skl_gemm_a1b01_bf16c_bf16_f32_xsfmm32a16f(size_t m, size_t n, size_t k,
                                               const __bf16 *a, size_t csa,
                                               const __bf16 *b, size_t rsb,
                                               float *c, size_t rsc,
                                               bool accum);

/**
 * @brief Xsfmm bfloat16 A * B packed matrix-matrix multiplication with float32
 * output.
 *
