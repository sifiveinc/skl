...
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
  ...
  float *c00_load = c00;
  size_t i = 0;
  __asm__ volatile("sf.vsettnt x0, %[tn], e16, w2\n"
                   "sf.vsettm x0, %[tm]\n"
  ...
  __asm__ volatile("beqz %[k], 2f\n"
                   ...
                   : [sa] "r"(2 * csa * sizeof(_Float16)),
                     [sb] "r"(2 * rsb * sizeof(_Float16)), [tm] "r"(tm),
                     [tn] "r"(tn), [i2] "r"(2)
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm2tn_2tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t rsa,
...
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm3tn_3tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t rsa,
    const _Float16 *b, size_t rsb0, size_t csb1, float *c, size_t rsc0,
    size_t tsc1, bool accum, bool bta) {
  // We can use the same inner loop code for both values of bta by computing A^T
...
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm4tn_4tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t rsa,
    const _Float16 *b, size_t rsb0, size_t csb1, float *c, size_t rsc0,
    size_t tsc1, bool accum, bool bta) {
  // We can use the same inner loop code for both values of bta by computing A^T
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm2tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t csa,
    const _Float16 *b, size_t rsb0, size_t csb1, float *c, size_t rsc0,
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_2tm1tn_a1b01_f16pc_f16_f32rcp_xsfmm32a16f(
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm3tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t csa,
    const _Float16 *b, size_t rsb0, size_t csb1, float *c, size_t rsc0,
    size_t csc1, bool accum) {
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_3tm1tn_a1b01_f16pc_f16_f32rcp_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t csa0, size_t rsa1,
    const _Float16 *b, size_t rsb, float *c, size_t rsc0, size_t rsc1,
    bool accum) {
  skl_gemm_1tm3tn_3tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_1tm4tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t csa,
    const _Float16 *b, size_t rsb0, size_t csb1, float *c, size_t rsc0,
    size_t csc1, bool accum) {
 ...
 */
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_4tm1tn_a1b01_f16pc_f16_f32rcp_xsfmm32a16f(
    size_t tm, size_t tn, size_t k, const _Float16 *a, size_t csa0, size_t rsa1,
    const _Float16 *b, size_t rsb, float *c, size_t rsc0, size_t rsc1,
    bool accum) {
  skl_gemm_1tm4tn_4tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
...
SKL_XSFMM_NEW
SKL_FUNC_PRIVATE void skl_gemm_2tn2tn_a1b01_f16pc_f16cp_f32rcp_xsfmm32a16f(
  ...
  if (k < 2) {
    ...
    __asm__ volatile(
        ...
        : [a0_0] "+&r"(a0_0), [a0_1] "+&r"(a0_1), [a1_0] "+&r"(a1_0),
          ...
          [b1_0] "+&r"(b1_0), [b1_1] "+&r"(b1_1), [k] "+&r"(k)
        : [sa] "r"(2 * csa0 * sizeof(_Float16)),
          [sb] "r"(2 * rsb0 * sizeof(_Float16)), [tm] "r"(tm), [tn] "r"(tn),
          [i4] "r"(4)
        : "v0", "v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8", "v9", "v10",
          "v11", "v12", "v13", "v14", "v15", "v16", "v17", "v18", "v19", "v20",
          "v21", "v22", "v23", "v24", "v25", "v26", "v27", "v28", "v29", "v30",
...
SKL_XSFMM_NEW
SKL_FUNC void skl_gemm_a1b01_f16c_f16_f32_xsfmm32a16f(
    size_t m, size_t n, size_t k, const _Float16 *a, size_t csa,
    const _Float16 *b, size_t rsb, float *c, size_t rsc, bool accum) {
  if (m == 0 || n == 0) {
    return;
  }
  ...
  __asm__ volatile("sf.vsettnt %0, x0, e16, w2" : "=r"(ete) : : "vtype", "vl");

  size_t i = 0;
  for (; i + 4 * ete <= m; i += 4 * ete) {
    size_t j = 0;
    for (; j + 2 * ete <= n; j += 2 * ete) {
      skl_gemm_2tn2tn_a1b01_f16pc_f16cp_f32rcp_xsfmm32a16f(
    ...
    while (j < n) {
      size_t tn = 0;
      __asm__ volatile("sf.vsettnt %0, %1, e16, w2"
                       : "=r"(tn)
                       : "r"(n - j)
                       : "vtype", "vl");
  ...
  while (i < m) {
    size_t tm = 0;
    __asm__ volatile("sf.vsettnt x0, x0, e16, w2\n"
                     "sf.vsettm %0, %1\n"
                     : "=r"(tm)
                     : "r"(m - i)
                     : "vtype", "vl");
    ...
    for (; j + 4 * ete <= n; j += 4 * ete) {
      skl_gemm_1tm4tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
          tm, ete, k, a + i, csa, b + j, rsb, ete, c + i * rsc + j, rsc, ete,
          accum);
    }
    if (j + 3 * ete <= n) {
      skl_gemm_1tm3tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
          tm, ete, k, a + i, csa, b + j, rsb, ete, c + i * rsc + j, rsc, ete,
          accum);
      j += 3 * ete;
    }
    if (j + 2 * ete <= n) {
      skl_gemm_1tm2tn_a1b01_f16c_f16cp_f32rcp_xsfmm32a16f(
          tm, ete, k, a + i, csa, b + j, rsb, ete, c + i * rsc + j, rsc, ete,
          accum);
      j += 2 * ete;
    }
    while (j < n) {
      ...
      __asm__ volatile("sf.vsettnt %0, %1, e16, w2"
                       ...
                       : "r"(n - j)
                       : "vtype", "vl");
      skl_gemm_1tm1tn_a1b01_f16c_f16_f32_xsfmm32a16f(
