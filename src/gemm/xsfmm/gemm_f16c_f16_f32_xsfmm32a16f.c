...
void skl_gemm_tile_zero_f16_f32_xsfmmbase(size_t m, size_t n, size_t tss,
  ...
  skl_gemm_tile_zero_f16_f32_xsfmmbase_t tile_zero_functions[] = {
      &skl_gemm_tile_zero_mt0_f16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt4_f16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt8_f16_f32_xsfmmbase,
      &skl_gemm_tile_zero_mt12_f16_f32_xsfmmbase,
  };
 ...
 */
SKL_FUNC_PRIVATE
void skl_gemm_apply_fused_f16_f32_f32rcptexterc_xsfmmbase(
...
void skl_gemm_alpha_beta_scaling_f16_f32_f32rcptexterc_xsfmmbase(
  ...
  if (ete <= (size_t)__riscv_vsetvlmax_e32m2() && csc0 == 1) {
    skl_gemm_alpha_beta_scaling_m2_f16_f32_f32_xsfmmbase(tm, tn, alpha, tss,
                                                         beta, c_block, rsc0);
  } else {
    skl_gemm_alpha_beta_scaling_m8_f16_f32_f32rc_xsfmmbase(
...
skl_gemm_inner_loop_1x1_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f(
  ...
  const _Float16 *a0 = a;
  const _Float16 *a1 = a0 + csa1;
  const _Float16 *b0 = b;
  const _Float16 *b1 = b0 + rsb1;
  __asm__ volatile("beqz %[k], 2f\n"

                   "sf.vsettnt x0, %[n], e16, w2\n"
                   "sf.vsettm x0, %[m]\n"
                   "sf.vsettk x0, %[k]\n"
                   ...
                   : [csa1] "r"(2 * csa1 * sizeof(_Float16)),
                     [rsb1] "r"(2 * rsb1 * sizeof(_Float16)), [m] "r"(m),
                     [n] "r"(n), [i2] "r"(2)
...
skl_gemm_inner_loop_1x2_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f(
  ...
  const _Float16 *a0_1 = a0_0 + csa1;
  const _Float16 *b0_0 = b;
  const _Float16 *b0_1 = b0_0 + rsb1;
  const _Float16 *b1_0 = b0_0 + csb1;
  const _Float16 *b1_1 = b1_0 + rsb1;
  if (k < 2) {
...
skl_gemm_inner_loop_1x3_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f(
  ...
  const _Float16 *b1_0 = b0_0 + csb1;
  const _Float16 *b1_1 = b1_0 + rsb1;
  const _Float16 *b2_0 = b0_0 + 2 * csb1;
  const _Float16 *b2_1 = b2_0 + rsb1;
  if (k < 2) {
    __asm__ volatile("beqz %[k], 0f\n"
    ...
    __asm__ volatile(
        ...
        : [csa1] "r"(2 * csa1 * sizeof(_Float16)),
          [rsb1] "r"(2 * rsb1 * sizeof(_Float16)), [m] "r"(m), [tn0] "r"(tn0),
...
skl_gemm_inner_loop_1x4_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f(
  ...
  const _Float16 *b2_0 = b0_0 + 2 * csb1;
  const _Float16 *b2_1 = b2_0 + rsb1;
  const _Float16 *b3_0 = b0_0 + 3 * csb1;
  const _Float16 *b3_1 = b3_0 + rsb1;
  if (k < 2) {
    __asm__ volatile(
        "beqz %[k], 0f\n"
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_apply_tiling_f16rcptex1c_f16rcp1xte_f32_f32rcptexterc_xsfmm32a16f(
    size_t m1, size_t n1,
    skl_gemm_inner_loop_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f_t inner_loop,
    size_t m, size_t n, size_t k, const _Float16 *a, size_t rsa1, size_t csa1,
  ...
  if (accum) {
    skl_gemm_tile_load_f16_f32rcptexterc_f32_xsfmmbase(
        m, n, c + row1 * rsc1 + col1 * csc1, rsc0, csc0, rsc1, csc1,
        trans ? mt0c : mt0, rstss, cstss);
  } else {
    if (trans) {
      // NOLINTBEGIN(readability-suspicious-call-argument)
      skl_gemm_tile_zero_f16_f32_xsfmmbase(n, m, mt0, cstss, rstss);
      // NOLINTEND(readability-suspicious-call-argument)
    } else {
      skl_gemm_tile_zero_f16_f32_xsfmmbase(m, n, mt0, rstss, cstss);
    }
  }
  ...
  skl_gemm_apply_fused_f16_f32_f32rcptexterc_xsfmmbase(
...
#define SKL_GEMM_TILE(M1, N1, M1XN1, M, N, ROW1, COL1)                          \
  do {                                                                          \
    skl_gemm_apply_tiling_f16rcptex1c_f16rcp1xte_f32_f32rcptexterc_xsfmm32a16f( \
        M1, N1,                                                                 \
        skl_gemm_inner_loop_##M1XN1##_f16rcptex1c_f16rcp1xte_f32_xsfmm32a16f,   \
 ...
 */
SKL_FUNC_PRIVATE void
skl_gemm_fused_f16rcptex1c_f16rcp1xte_f32rcptexterc_xsfmm32a16f(
    size_t m, size_t n, size_t k, const _Float16 *a, size_t rsa1, size_t csa1,
    const _Float16 *b, size_t rsb1, size_t csb1, float *c, size_t rsc0,
...
SKL_FUNC void skl_gemm_f16c_f16_f32_xsfmm32a16f(size_t m, size_t n, size_t k,
                                                float alpha, const _Float16 *a,
                                                size_t csa, const _Float16 *b,
                                                size_t rsb, float beta,
                                                float *c, size_t rsc) {
  skl_gemm_alpha_beta_scaling_params_f16_f32_f32rcptexterc_xsfmmbase_t params =
  ...
  skl_gemm_fused_f16rcptex1c_f16rcp1xte_f32rcptexterc_xsfmm32a16f(
      ...
      skl_gemm_alpha_beta_scaling_f16_f32_f32rcptexterc_xsfmmbase, &params);
}

/* Computes C = alpha * A * B + beta * C for packed matrices A, B, and C. */
SKL_FUNC void skl_gemm_f16rcptex1c_f16rcp1xte_f32rcptexterc_xsfmm32a16f(
  ...
  skl_gemm_fused_f16rcptex1c_f16rcp1xte_f32rcptexterc_xsfmm32a16f(
      ...
      csc1, false, skl_gemm_alpha_beta_scaling_f16_f32_f32rcptexterc_xsfmmbase,
      &params);
}
