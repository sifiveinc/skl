...
skl_pack_tile_load_e8_e8_xsfmmbase(size_t tm, size_t tn, const uint8_t *src,
...
SKL_FUNC_PRIVATE void skl_pack_tile_store_pad_bottom_e8_e8_xsfmmbase(
    ...
    size_t rs, uint8_t pad) SKL_XSFMM_IN {
  if (m0 == 0 || n0 == 0) {
    return;
  }
...
SKL_FUNC_PRIVATE void skl_pack_tile_store_load_e8_e8_xsfmmbase(
    ...
    size_t rssrc, size_t tss_load, uint8_t pad) SKL_XSFMM_INOUT {
 ...
 */
SKL_FUNC_PRIVATE void
skl_pack_tile_set_e8_xsfmmbase(size_t tm, size_t tn, size_t tss,
                               uint8_t pad) SKL_XSFMM_INOUT {
  if (tm == 0 || tn == 0) {
    return;
  }
...
SKL_FUNC_PRIVATE void skl_pack_padding_optional_e8_e8rcptextec_xsfmmbase(
    ...
    size_t rs1, size_t cs1, bool pad_right, bool pad_bottom,
    uint8_t pad) SKL_XSFMM_NEW {
  if (m == 0 || n == 0) {
    return;
  }
