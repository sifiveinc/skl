...
/**
 * @brief RVV-based 16-bit general matrix unpack kernel (blocked 4D to 2D
 * layout).
 *
 ...
 * @note Input and output matrices must not overlap.
 */
void skl_unpack_e16rcprc_e16rc_zve32x(size_t m0, size_t n0,
...
/**
 * @brief RVV matrix transposition for 16-bit matrices.
 *
