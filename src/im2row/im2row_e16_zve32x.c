...
SKL_FUNC void skl_im2row_hwc_e16_zve32x(
  ...
  skl_im2row_hwc_zve32x(
      out, in_batch, sizeof(uint16_t), in_h_origin, in_w_origin, in_c_origin,
...
SKL_FUNC void skl_im2row_d1_full_patch_hwc_e16_zve32x(
    uint16_t *out, const uint16_t *in_batch, int32_t in_h_origin,
  ...
  skl_im2row_d1_full_patch_hwc_zve32x(
      out, in_batch, sizeof(uint16_t), in_h_origin, in_w_origin, input_height,
