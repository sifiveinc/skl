...
/**
 * @file depthwise_conv2d_f32_f32_f32_zve32f.h
 * @brief RVV-optimized float32 depthwise convolution 2D kernels.
 *
 * This header provides RVV-optimized implementations of depthwise convolution
 * 2D operations for IEEE 754 binary32 (float) input/filter/output data.
 ...
 * @note Requires RISC-V Zve32f vector extension
 */
...
/**
 * @brief RVV float32 depthwise convolution 2D.
 *
...
/**
 * @brief RVV float32 depthwise convolution 2D optimized for 3x3 filters.
 *
 * @param output - Pointer to output tensor (HWC layout).
 * @param input - Pointer to input tensor (HWC layout).
 * @param filter - Pointer to filter tensor (HWIM layout).
