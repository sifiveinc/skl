...
__attribute__((unused)) SKL_FUNC_PRIVATE vfloat16m4_t
skl_depthwise_conv2d_post_process_output_clamp_vf16m4(
    vfloat16m4_t v_sum, size_t vl, _Float16 output_activation_min,
    _Float16 output_activation_max) {
  v_sum = __riscv_vfmax_vf_f16m4(v_sum, output_activation_min, vl);
  v_sum = __riscv_vfmin_vf_f16m4(v_sum, output_activation_max, vl);
  return v_sum;
}

SKL_FUNC_PRIVATE vfloat16m4_t
skl_depthwise_conv2d_post_process_output_linear_vf16m4(
    vfloat16m4_t v_sum, size_t vl, _Float16 output_activation_min,
    _Float16 output_activation_max) {
  (void)vl;
...
skl_depthwise_conv2d_vc_fnxn_sn_dn_mn_in_hwc_f16_f16_f16_internal_zvfh(
    _Float16 *output, const _Float16 *input, const _Float16 *filter,
    const _Float16 *bias, size_t input_height, size_t input_width,
    ...
    vfloat16m4_t (*post_process_output_func)(vfloat16m4_t, size_t, _Float16,
                                             _Float16),
    _Float16 output_activation_min, _Float16 output_activation_max) {
  ...
  if (depth_multiplier == 1) {
    for (size_t output_c_avl = output_channel, vl; output_c_avl > 0;
         output_c_avl -= vl) {
      vl = __riscv_vsetvl_e16m4(output_c_avl);

      const _Float16 *input_ptr = input;
      _Float16 *output_ptr = output;

      // NOLINTBEGIN(clang-analyzer-deadcode.DeadStores)
      vfloat16m4_t v_init_output_f16 = __riscv_vundefined_f16m4();
      // NOLINTEND(clang-analyzer-deadcode.DeadStores)
      if (bias != NULL) {
        v_init_output_f16 = __riscv_vle16_v_f16m4(bias, vl);
      } else {
        v_init_output_f16 = __riscv_vfmv_v_f_f16m4(0, vl);
      }

      for (size_t output_h = 0; output_h < output_height; output_h++) {
        for (size_t output_w = 0; output_w < output_width; output_w++) {
          vfloat16m4_t v_output_f16 =
              __riscv_vmv_v_v_f16m4(v_init_output_f16, vl);
            ...
            if (0 <= in_y && in_y < (int32_t)input_height) {
              ...
              for (size_t filter_w = 0; filter_w < filter_width; filter_w++) {
                if (0 <= in_x && in_x < (int32_t)input_width) {
                  vfloat16m4_t v_input_f16 = __riscv_vle16_v_f16m4(
                      input_ptr + (size_t)in_y * input_row_stride +
                          (size_t)in_x * input_col_stride,
                      vl);
                  vfloat16m4_t v_filter_f16 = __riscv_vle16_v_f16m4(
                      filter + filter_h * filter_row_stride +
                          filter_w * filter_col_stride,
                      vl);

                  v_output_f16 = __riscv_vfmacc_vv_f16m4(
                      v_output_f16, v_input_f16, v_filter_f16, vl);
                }
    ...
    if (input_channel == 1) {
          ...
          for (size_t output_w = 0; output_w < output_width; output_w++) {
            ...
            for (size_t filter_h = 0; filter_h < filter_height; filter_h++) {
              if (0 <= in_y && in_y < (int32_t)input_height) {
                ...
                for (size_t filter_w = 0; filter_w < filter_width; filter_w++) {
                  if (0 <= in_x && in_x < (int32_t)input_width) {
                    vfloat16m4_t v_input_f16 = __riscv_vlse16_v_f16m4(
                        input_ptr + (size_t)in_y * input_row_stride +
                            (size_t)in_x * input_col_stride,
                        0, vl);
                    vfloat16m4_t v_filter_f16 = __riscv_vle16_v_f16m4(
      ...
      size_t float16_data_stride = depth_multiplier * sizeof(_Float16);

      for (size_t input_c_avl = input_channel, vl; input_c_avl > 0;
           input_c_avl -= vl) {
        vl = __riscv_vsetvl_e16m4(input_c_avl);
        ...
        for (size_t m = 0; m < depth_multiplier; m++) {
          ...
          // NOLINTEND(clang-analyzer-deadcode.DeadStores)
          if (bias != NULL) {
            v_init_output_f16 = __riscv_vlse16_v_f16m4(
                bias, (ptrdiff_t)float16_data_stride, vl);
          } else {
            v_init_output_f16 = __riscv_vfmv_v_f_f16m4(0, vl);
          }
                    ...
                    if (0 <= in_x && in_x < (int32_t)input_width) {
                      vfloat16m4_t v_input_f16 = __riscv_vle16_v_f16m4(
                          input_ptr + (size_t)in_y * input_row_stride +
                              (size_t)in_x * input_col_stride,
                          vl);
                      vfloat16m4_t v_filter_f16 = __riscv_vlse16_v_f16m4(
                          filter + filter_h * filter_row_stride +
                              filter_w * filter_col_stride,
                          (ptrdiff_t)float16_data_stride, vl);
...
void skl_depthwise_conv2d_vc_fnxn_sn_dn_mn_in_hwc_f16_f16_f16_zvfh(
  ...
  skl_depthwise_conv2d_vc_fnxn_sn_dn_mn_in_hwc_f16_f16_f16_internal_zvfh(
      ...
      output_col_stride, skl_depthwise_conv2d_post_process_output_linear_vf16m4,
      0, 0);
}

SKL_FUNC_PRIVATE vfloat16m4_t skl_depthwise_conv2d_unit_stride_load_vf16m4(
    const _Float16 *ptr, size_t data_stride, size_t vl) {
  (void)data_stride;
  return __riscv_vle16_v_f16m4(ptr, vl);
}

SKL_FUNC_PRIVATE vfloat16m4_t skl_depthwise_conv2d_strided_load_vf16m4(
    const _Float16 *ptr, size_t data_stride, size_t vl) {
  return __riscv_vlse16_v_f16m4(ptr, (ptrdiff_t)data_stride, vl);
}

SKL_FUNC_PRIVATE void
skl_depthwise_conv2d_unit_stride_store_vf16m4(_Float16 *ptr, size_t data_stride,
                                              vfloat16m4_t v_data, size_t vl) {
  (void)data_stride;
  __riscv_vse16_v_f16m4(ptr, v_data, vl);
}

SKL_FUNC_PRIVATE void
skl_depthwise_conv2d_strided_store_vf16m4(_Float16 *ptr, size_t data_stride,
                                          vfloat16m4_t v_data, size_t vl) {
  __riscv_vsse16_v_f16m4(ptr, (ptrdiff_t)data_stride, v_data, vl);
}

SKL_FUNC_PRIVATE vfloat16m4_t skl_depthwise_conv2d_init_accum_by_vector_vf16m4(
    vfloat16m4_t v_init_sum, size_t vl, const _Float16 *output,
    vfloat16m4_t (*load_func)(const _Float16 *, size_t, size_t),
    size_t data_stride) {
  (void)output;
  (void)load_func;
  (void)data_stride;
  return __riscv_vmv_v_v_f16m4(v_init_sum, vl);
}

SKL_FUNC_PRIVATE vfloat16m4_t
skl_depthwise_conv2d_init_accum_by_partial_accum_vf16m4(
    vfloat16m4_t v_init_sum, size_t vl, const _Float16 *output,
    vfloat16m4_t (*load_func)(const _Float16 *, size_t, size_t),
    size_t data_stride) {
  (void)v_init_sum;
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_padding_sliding_vf16m4(
    vfloat16m4_t v_init_sum, _Float16 *output, size_t out_x_start,
    size_t out_x_end, size_t output_col_stride, _Float16 output_activation_min,
    _Float16 output_activation_max, size_t vl, size_t data_stride,
    vfloat16m4_t (*init_sum_func)(vfloat16m4_t, size_t, const _Float16 *,
                                  vfloat16m4_t (*)(const _Float16 *, size_t,
                                                   size_t),
                                  size_t),
    vfloat16m4_t (*post_process_output_func)(vfloat16m4_t, size_t, _Float16,
                                             _Float16),
    vfloat16m4_t (*load_func)(const _Float16 *, size_t, size_t),
    void (*store_func)(_Float16 *, size_t, vfloat16m4_t, size_t)) {
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_overlapped_0_sliding_vf16m4(
    const _Float16 *input, vfloat16m4_t v_filter_0, vfloat16m4_t v_filter_1,
    vfloat16m4_t v_filter_2, vfloat16m4_t v_init_sum, _Float16 *output,
    ...
    size_t output_col_stride, _Float16 output_activation_min,
    _Float16 output_activation_max, size_t vl, size_t data_stride,
    vfloat16m4_t (*init_sum_func)(vfloat16m4_t, size_t, const _Float16 *,
                                  vfloat16m4_t (*)(const _Float16 *, size_t,
                                                   size_t),
  ...
  for (size_t out_x = 0; out_x < output_width; out_x++) {
    ...
    if (left_in_x >= 0 && left_in_x < (int32_t)input_width) {
      vfloat16m4_t v_left_input = __riscv_vle16_v_f16m4(
          input + (size_t)left_in_x * input_col_stride, vl);
      v_sum = __riscv_vfmacc_vv_f16m4(v_sum, v_left_input, v_filter_0, vl);
    }
    if (mid_in_x >= 0 && mid_in_x < (int32_t)input_width) {
      vfloat16m4_t v_mid_input = __riscv_vle16_v_f16m4(
          input + (size_t)mid_in_x * input_col_stride, vl);
      v_sum = __riscv_vfmacc_vv_f16m4(v_sum, v_mid_input, v_filter_1, vl);
    }
    if (right_in_x >= 0 && right_in_x < (int32_t)input_width) {
      vfloat16m4_t v_right_input = __riscv_vle16_v_f16m4(
          input + (size_t)right_in_x * input_col_stride, vl);
      v_sum = __riscv_vfmacc_vv_f16m4(v_sum, v_right_input, v_filter_2, vl);
    }
    v_sum = post_process_output_func(v_sum, vl, output_activation_min,
                                     output_activation_max);
    store_func(output + out_x * output_col_stride, data_stride, v_sum, vl);
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_dot_product_1x3_vf16m4(
    vfloat16m4_t v_left_input, vfloat16m4_t v_mid_input,
    vfloat16m4_t v_right_input, const vfloat16m4_t v_filter_0,
    const vfloat16m4_t v_filter_1, const vfloat16m4_t v_filter_2,
    const vfloat16m4_t v_init_sum, _Float16 *output,
    _Float16 output_activation_min, _Float16 output_activation_max, size_t vl,
    size_t data_stride,
    vfloat16m4_t (*init_sum_func)(vfloat16m4_t, size_t, const _Float16 *,
                                  vfloat16m4_t (*)(const _Float16 *, size_t,
                                                   size_t),
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_dot_product_1x3_partial_001_vf16m4(
    vfloat16m4_t v_left_input, vfloat16m4_t v_mid_input,
    vfloat16m4_t v_right_input, const vfloat16m4_t v_filter_0,
    const vfloat16m4_t v_filter_1, const vfloat16m4_t v_filter_2,
    const vfloat16m4_t v_init_sum, _Float16 *output,
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_dot_product_1x3_partial_011_vf16m4(
    vfloat16m4_t v_left_input, vfloat16m4_t v_mid_input,
    vfloat16m4_t v_right_input, const vfloat16m4_t v_filter_0,
    const vfloat16m4_t v_filter_1, const vfloat16m4_t v_filter_2,
    const vfloat16m4_t v_init_sum, _Float16 *output,
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_dot_product_1x3_partial_100_vf16m4(
    vfloat16m4_t v_left_input, vfloat16m4_t v_mid_input,
    vfloat16m4_t v_right_input, const vfloat16m4_t v_filter_0,
    const vfloat16m4_t v_filter_1, const vfloat16m4_t v_filter_2,
    const vfloat16m4_t v_init_sum, _Float16 *output,
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_dot_product_1x3_partial_110_vf16m4(
    vfloat16m4_t v_left_input, vfloat16m4_t v_mid_input,
    vfloat16m4_t v_right_input, const vfloat16m4_t v_filter_0,
    const vfloat16m4_t v_filter_1, const vfloat16m4_t v_filter_2,
    const vfloat16m4_t v_init_sum, _Float16 *output,
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_overlapped_1_sliding_vf16m4(
    const _Float16 *input, vfloat16m4_t v_filter_0, vfloat16m4_t v_filter_1,
    vfloat16m4_t v_filter_2, vfloat16m4_t v_init_sum, _Float16 *output,
    size_t input_width, size_t output_width, size_t pad_width,
    size_t stride_width, size_t dilation_width_factor, size_t input_col_stride,
    size_t output_col_stride, _Float16 output_activation_min,
    _Float16 output_activation_max, size_t overlap_period,
  ...
  for (size_t out_start_offset = 0; out_start_offset < overlap_period;
    ...
    const _Float16 *current_input =
        input + ((out_x * stride_width) - pad_width) * input_col_stride;
    _Float16 *current_output = output + out_x * output_col_stride;

    // NOLINTBEGIN(clang-analyzer-deadcode.DeadStores)
    vfloat16m4_t v_input_0 = __riscv_vundefined_f16m4();
    vfloat16m4_t v_input_1 = __riscv_vundefined_f16m4();
    vfloat16m4_t v_input_2 = __riscv_vundefined_f16m4();
    // NOLINTEND(clang-analyzer-deadcode.DeadStores)

    v_input_0 = __riscv_vle16_v_f16m4(current_input, vl);
    ...
    if ((int32_t)out_x - (int32_t)overlap_period >= 0) {
      if ((int32_t)out_x * (int32_t)stride_width - (int32_t)pad_width -
        ...
        //                                       ^
        //                                       current_input
        v_input_2 = __riscv_vle16_v_f16m4(
            current_input - next_input_stride - next_input_stride, vl);

        skl_depthwise_conv2d_dot_product_1x3_partial_011_vf16m4(
            __riscv_vundefined_f16m4(), v_input_2, v_input_0, v_filter_0,
        ...
        //                                       ^
        //                                       current_input
        skl_depthwise_conv2d_dot_product_1x3_partial_001_vf16m4(
            __riscv_vundefined_f16m4(), __riscv_vundefined_f16m4(), v_input_0,
    ...
    while (out_x + 2 * overlap_period < non_pad_out_x_end) {
      v_input_1 = __riscv_vle16_v_f16m4(current_input, vl);
      current_input += next_input_stride;
      v_input_2 = __riscv_vle16_v_f16m4(current_input, vl);
      current_input += next_input_stride;
      skl_depthwise_conv2d_dot_product_1x3_vf16m4(
    ...
    if (out_x < output_width) {
      ...
      case 0:
        if (out_x * stride_width - pad_width + dilation_width_factor <
          ...
          // out_x                 :            I0 I1 -
          v_input_1 = __riscv_vle16_v_f16m4(current_input, vl);
          skl_depthwise_conv2d_dot_product_1x3_partial_110_vf16m4(
              v_input_0, v_input_1, __riscv_vundefined_f16m4(), v_filter_0,
          ...
          // out_x - overlap_period:      I1 I2 I0
          // out_x                 :            I0 -  -
          skl_depthwise_conv2d_dot_product_1x3_partial_100_vf16m4(
              v_input_0, __riscv_vundefined_f16m4(), __riscv_vundefined_f16m4(),
      ...
      case 1:
        if (out_x * stride_width - pad_width + dilation_width_factor <
          ...
          v_input_0 = __riscv_vle16_v_f16m4(current_input, vl);
          skl_depthwise_conv2d_dot_product_1x3_partial_110_vf16m4(
              v_input_2, v_input_0, __riscv_vundefined_f16m4(), v_filter_0,
              v_filter_1, v_filter_2, v_init_sum, current_output,
              output_activation_min, output_activation_max, vl, data_stride,
              init_sum_func, post_process_output_func, load_func, store_func);
        } else {
          ...
          // out_x                 :            I2 -  -
          skl_depthwise_conv2d_dot_product_1x3_partial_100_vf16m4(
              v_input_2, __riscv_vundefined_f16m4(), __riscv_vundefined_f16m4(),
              v_filter_0, v_filter_1, v_filter_2, v_init_sum, current_output,
              output_activation_min, output_activation_max, vl, data_stride,
              init_sum_func, post_process_output_func, load_func, store_func);
        }
      ...
      case 2:
        if (out_x * stride_width - pad_width + dilation_width_factor <
          ...
          v_input_2 = __riscv_vle16_v_f16m4(current_input, vl);
          skl_depthwise_conv2d_dot_product_1x3_partial_110_vf16m4(
              v_input_1, v_input_2, __riscv_vundefined_f16m4(), v_filter_0,
              v_filter_1, v_filter_2, v_init_sum, current_output,
              output_activation_min, output_activation_max, vl, data_stride,
              init_sum_func, post_process_output_func, load_func, store_func);
        } else {
          ...
          // out_x                 :            I1 -  -
          skl_depthwise_conv2d_dot_product_1x3_partial_100_vf16m4(
              v_input_1, __riscv_vundefined_f16m4(), __riscv_vundefined_f16m4(),
              v_filter_0, v_filter_1, v_filter_2, v_init_sum, current_output,
              output_activation_min, output_activation_max, vl, data_stride,
              init_sum_func, post_process_output_func, load_func, store_func);
        }
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_overlapped_2_sliding_vf16m4(
    const _Float16 *input, vfloat16m4_t v_filter_0, vfloat16m4_t v_filter_1,
    vfloat16m4_t v_filter_2, vfloat16m4_t v_init_sum, _Float16 *output,
  ...
  for (size_t out_start_offset = 0; out_start_offset < overlap_period;
    ...
    if ((int32_t)out_x - (int32_t)overlap_period >= 0) {
      skl_depthwise_conv2d_dot_product_1x3_partial_011_vf16m4(
          __riscv_vundefined_f16m4(), v_input_0, v_input_1, v_filter_0,
          v_filter_1, v_filter_2, v_init_sum,
          current_output - next_output_stride, output_activation_min,
          output_activation_max, vl, data_stride, init_sum_func,
          post_process_output_func, load_func, store_func);
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_process_1x3_vf16m4(
    const _Float16 *input, const _Float16 *filter, vfloat16m4_t v_init_sum,
    _Float16 *output, size_t input_height, size_t input_width,
    ...
    size_t vl, size_t float16_data_stride,
    vfloat16m4_t (*init_sum_func)(vfloat16m4_t, size_t, const _Float16 *,
                                  vfloat16m4_t (*)(const _Float16 *, size_t,
                                                   size_t),
                                  size_t),
    ...
    vfloat16m4_t (*load_func)(const _Float16 *, size_t, size_t),
    void (*store_func)(_Float16 *, size_t, vfloat16m4_t, size_t)) {
  vfloat16m4_t v_filter_0 =
      load_func(filter + 0 * filter_col_stride, float16_data_stride, vl);
  vfloat16m4_t v_filter_1 =
      load_func(filter + 1 * filter_col_stride, float16_data_stride, vl);
  vfloat16m4_t v_filter_2 =
      load_func(filter + 2 * filter_col_stride, float16_data_stride, vl);
  ...
  for (size_t out_y = 0; out_y < output_height;
    ...
    _Float16 *current_output = output + out_y * output_row_stride;

    if (in_y < 0 || in_y >= (int32_t)input_height) {
      for (size_t out_x = 0; out_x < output_width; out_x++) {
        vfloat16m4_t v_sum = init_sum_func(
            v_init_sum, vl, current_output + out_x * output_col_stride,
            load_func, float16_data_stride);
        v_sum = post_process_output_func(v_sum, vl, output_activation_min,
                                         output_activation_max);
        store_func(current_output + out_x * output_col_stride,
                   float16_data_stride, v_sum, vl);
      }
    } else {
      const _Float16 *current_input = input + (size_t)in_y * input_row_stride;
      if (overlap_num == 0 ||
          non_pad_out_x_start + overlap_period > non_pad_out_x_end) {
        skl_depthwise_conv2d_overlapped_0_sliding_vf16m4(
            ...
            output_activation_min, output_activation_max, vl,
            float16_data_stride, init_sum_func, post_process_output_func,
            load_func, store_func);
      } else {
        if ((int32_t)non_pad_out_x_start -
                (int32_t)overlap_num * (int32_t)overlap_period >=
            0) {
          skl_depthwise_conv2d_padding_sliding_vf16m4(
              ...
              vl, float16_data_stride, init_sum_func, post_process_output_func,
              load_func, store_func);
        }

        if (overlap_num == 1) {
          skl_depthwise_conv2d_overlapped_1_sliding_vf16m4(
              current_input, v_filter_0, v_filter_1, v_filter_2, v_init_sum,
          ...
          skl_depthwise_conv2d_overlapped_2_sliding_vf16m4(
              current_input, v_filter_0, v_filter_1, v_filter_2, v_init_sum,
              current_output, output_width, pad_width, stride_width,
              dilation_width_factor, input_col_stride, output_col_stride,
              output_activation_min, output_activation_max, overlap_period,
              non_pad_out_x_start, non_pad_out_x_end, vl, float16_data_stride,
              init_sum_func, post_process_output_func, load_func, store_func);
        }
...
SKL_FUNC_PRIVATE void skl_depthwise_conv2d_process_3x3_vf16m4(
    const _Float16 *input, const _Float16 *filter, vfloat16m4_t v_init_sum,
    _Float16 *output, size_t input_height, size_t input_width,
    ...
    size_t output_col_stride, _Float16 output_activation_min,
    _Float16 output_activation_max, size_t vl, size_t float16_data_stride,
    vfloat16m4_t (*load_func)(const _Float16 *, size_t, size_t),
    void (*store_func)(_Float16 *, size_t, vfloat16m4_t, size_t)) {
  ...
  skl_depthwise_conv2d_process_1x3_vf16m4(
      ...
      float16_data_stride, skl_depthwise_conv2d_init_accum_by_vector_vf16m4,
      skl_depthwise_conv2d_post_process_output_linear_vf16m4, load_func,
      store_func);
...
SKL_FUNC_PRIVATE void
skl_depthwise_conv2d_vc_f3x3_sn_dn_mn_in_hwc_f16_f16_f16_internal_zvfh(
    _Float16 *output, const _Float16 *input, const _Float16 *filter,
    const _Float16 *bias, size_t input_height, size_t input_width,
    size_t input_channel, size_t output_height, size_t output_width,
    size_t output_channel, size_t depth_multiplier, size_t pad_height,
    size_t pad_width, size_t stride_height, size_t stride_width,
    size_t dilation_height_factor, size_t dilation_width_factor,
    size_t input_row_stride, size_t input_col_stride, size_t filter_row_stride,
    size_t filter_col_stride, size_t output_row_stride,
  ...
  for (size_t channel = input_channel, vl = 0; channel > 0; channel -= vl) {
    vl = __riscv_vsetvl_e16m4(channel);

    if (depth_multiplier == 1) {
      // NOLINTBEGIN(clang-analyzer-deadcode.DeadStores)
      vfloat16m4_t v_init_sum = __riscv_vundefined_f16m4();
      // NOLINTEND(clang-analyzer-deadcode.DeadStores)
      if (bias != NULL) {
        v_init_sum = __riscv_vle16_v_f16m4(bias, vl);
      } else {
        v_init_sum = __riscv_vfmv_v_f_f16m4(0, vl);
      }

      skl_depthwise_conv2d_process_3x3_vf16m4(
          ...
          filter_col_stride, output_row_stride, output_col_stride,
          output_activation_min, output_activation_max, vl, float16_data_stride,
          skl_depthwise_conv2d_unit_stride_load_vf16m4,
          skl_depthwise_conv2d_unit_stride_store_vf16m4);
      ...
      for (size_t m = 0; m < depth_multiplier; m++) {
        ...
        if (bias != NULL) {
          v_init_sum =
              __riscv_vlse16_v_f16m4(bias, (ptrdiff_t)float16_data_stride, vl);
        } else {
          v_init_sum = __riscv_vfmv_v_f_f16m4(0, vl);
        }
        ...
        skl_depthwise_conv2d_process_3x3_vf16m4(
            ...
            filter_col_stride, output_row_stride, output_col_stride,
            output_activation_min, output_activation_max, vl,
            float16_data_stride, skl_depthwise_conv2d_strided_load_vf16m4,
            skl_depthwise_conv2d_strided_store_vf16m4);
