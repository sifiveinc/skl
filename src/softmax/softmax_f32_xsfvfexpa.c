...
SKL_FUNC void skl_softmax_f32_xsfvfexpa(float *dst, const float *src,
  ...
  for (size_t i = 0; i < n; i += vl) {
    ...
    __riscv_vse32_v_f32m8(dst + i, vy, vl);
  }
...
SKL_FUNC void skl_softmax_f32r_xsfvfexpa(float *s, const size_t rss,
