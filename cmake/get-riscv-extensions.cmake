...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES "__riscv_zfh ")
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZFH")
else()
  set(RISCV_ZFH OFF)
endif()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES "__riscv_zvfh ")
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVFH")
else()
  set(RISCV_ZVFH OFF)
endif()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES "__riscv_zvfbfwma")
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVFBFWMA")
else()
...
if(${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zvfbfmin)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVFBFMIN")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zve32f)
  ...
  set(RISCV_ZVE32F ON)
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVE32F")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zve64d)
  ...
  set(RISCV_ZVE64D ON)
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVE64D")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zve32x)
  ...
  set(RISCV_ZVE32X ON)
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVE32X")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfmmbase)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFMM")
else()
  set(RISCV_XSFMM OFF)
endif()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfmm32a8f)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFMM32A8F")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfmm32a8i)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFMM32A8I")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfmm32a16f)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFMM32A16F")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfmm32a32f)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFNN32A32F")
else()
...
if(${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvfbfa)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVFBFA")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvfexpa)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVFEXPA")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvfexp16e)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVFEXP16E")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvfbfexp16e)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVFBFEXP16E")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvfexp32e)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVFEXP32E")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_xsfvqdotq)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_XSFVQDOTQ")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zvfofp8min)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVFOFP8MIN")
else()
...
if (${SKL_PREPROCESSOR_OUTPUT} MATCHES __riscv_zvfofp4min)
  ...
  list(APPEND RISCV_EXTENSIONS "RISCV_ZVFOFP4MIN")
else()
