...
/**
 * @brief Test cases for depthwise_conv2d with Zve32f extension.
 *
 * This test uses the depthwise_conv2d_f32_f32_f32 harness.
 */

#define TEST                                                                   \
  DEPTHWISE_CONV2D_F32_F32_F32_DEFAULTS,                                       \
      .steps = {                                                               \
          .init = depthwise_conv2d_f32_f32_f32_init,                           \
          .warmup = NULL,                                                      \
          .execute = execute,                                                  \
          .verify = depthwise_conv2d_f32_f32_f32_verify,                       \
          .report = NULL,                                                      \
          .cleanup = depthwise_conv2d_f32_f32_f32_cleanup,                     \
  }
...
#define BENCH                                                                  \
  DEPTHWISE_CONV2D_F32_F32_F32_DEFAULTS,                                       \
      .steps = {                                                               \
          ...
          .execute = execute,                                                  \
          .verify = NULL,                                                      \
          .report = depthwise_conv2d_f32_f32_f32_report,                       \
          .cleanup = depthwise_conv2d_f32_f32_f32_cleanup,                     \
  }
...
// clang-format off
depthwise_conv2d_f32_f32_f32_t tests[] = {
...
static skl_test_suite_t suite = {
    .name = "skl_depthwise_conv2d_f32_f32_f32_zve32f",
    .num_tests = sizeof(tests) / sizeof(tests[0]),
    .test_size = sizeof(depthwise_conv2d_f32_f32_f32_t),
    .tests = tests};

static void execute(skl_test_t *t) {
  const depthwise_conv2d_f32_f32_f32_t *h =
