...
/**
 * @brief Implementation of the unpack_e32rcprc_e32rc test harness.
 *
 * This file defines all harness functions _except_ `execute`, which is
 * defined in the test file (e.g. rvv/skl_unpack_e32rcprc_e32rc_zve32x.c).
 */

#include "unpack_e32rcprc_e32rc.h"
#include "skl-ref.h"
...
void unpack_e32rcprc_e32rc_init(skl_test_t *t) {
  unpack_e32rcprc_e32rc_t *h = (unpack_e32rcprc_e32rc_t *)t->harness;
...
void unpack_e32rcprc_e32rc_verify(skl_test_t *t) {
  ...
  skl_unpack_e32rcprc_e32rc_ref(h->m0, h->n0, h->src.data, h->rs0, h->cs0,
...
void unpack_e32rcprc_e32rc_benchmark_report(skl_test_t *t) {
  ...
  unpack_e32rcprc_e32rc_t *h = (unpack_e32rcprc_e32rc_t *)t->harness;
  unpack_e32rcprc_e32rc_test_report(t);
