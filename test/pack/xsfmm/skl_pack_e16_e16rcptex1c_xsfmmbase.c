...
static void init(skl_test_t *t) {
  ...
  pack_e16rc_e16rcprc_init(t);
}

static skl_test_suite_t suite = {.name = "skl_pack_e16_e16rcptex1c_xsfmmbase",
...
static void execute(skl_test_t *t) {
  ...
  skl_pack_e16_e16rcptex1c_xsfmmbase(h->m, h->n, h->src.data, h->rs,
