...
pack_e8_t tests[] = {
  ...
  // Benchmark tests
  {BENCH, .m = 128, .n = 128, .m0 = 8, .n0 = 8, .rs = 128, .cs = 1,
  ...
  {TEST, .m = 2, .n = 3, .m0 = 4, .n0 = 4, .rs = 3, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 16, .cs1 = 16},
  {TEST, .m = 2, .n = 3, .m0 = 4, .n0 = 4, .rs = 1, .cs = 2,
   .rs0 = 1, .cs0 = 4, .rs1 = 16, .cs1 = 16},
  {TEST, .m = 2, .n = 3, .m0 = 4, .n0 = 4, .rs = 3, .cs = 1,
  ...
  {TEST, .m = 5, .n = 5, .m0 = 4, .n0 = 8, .rs = 5, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 64, .cs1 = 32},
  {TEST, .m = 10, .n = 10, .m0 = 8, .n0 = 8, .rs = 10, .cs = 1,
   .rs0 = 1, .cs0 = 8, .rs1 = 128, .cs1 = 64},
  {TEST, .m = 7, .n = 9, .m0 = 4, .n0 = 4, .rs = 9, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 48, .cs1 = 16},
  {TEST, .m = 9, .n = 8, .m0 = 4, .n0 = 4, .rs = 8, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 32, .cs1 = 16},
  {TEST, .m = 20, .n = 16, .m0 = 8, .n0 = 8, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 8, .rs1 = 128, .cs1 = 64},

  {TEST, .m = 5, .n = 5, .m0 = 4, .n0 = 8, .rs = 1, .cs = 5,
   .rs0 = 1, .cs0 = 4, .rs1 = 64, .cs1 = 32},
  {TEST, .m = 10, .n = 10, .m0 = 8, .n0 = 8, .rs = 1, .cs = 10,
   .rs0 = 8, .cs0 = 1, .rs1 = 128, .cs1 = 64},
  {TEST, .m = 7, .n = 9, .m0 = 4, .n0 = 4, .rs = 1, .cs = 7,
   .rs0 = 4, .cs0 = 1, .rs1 = 48, .cs1 = 16},
  {TEST, .m = 9, .n = 8, .m0 = 4, .n0 = 4, .rs = 1, .cs = 9,
   .rs0 = 1, .cs0 = 4, .rs1 = 32, .cs1 = 16},
  {TEST, .m = 20, .n = 16, .m0 = 8, .n0 = 8, .rs = 1, .cs = 20,
   .rs0 = 1, .cs0 = 8, .rs1 = 128, .cs1 = 64},


  /* Multiple of block size  */
  {TEST, .m = 8, .n = 8, .m0 = 4, .n0 = 4, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 8, .rs1 = 64, .cs1 = 32},
  {TEST, .m = 12, .n = 12, .m0 = 4, .n0 = 4, .rs = 12, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 48, .cs1 = 16},
  {TEST, .m = 16, .n = 16, .m0 = 4, .n0 = 4, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 64, .cs1 = 16},
  {TEST, .m = 16, .n = 16, .m0 = 4, .n0 = 8, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 4, .rs1 = 64, .cs1 = 32},
  {TEST, .m = 16, .n = 16, .m0 = 8, .n0 = 8, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 8, .rs1 = 128, .cs1 = 64},
  {TEST, .m = 16, .n = 16, .m0 = 16, .n0 = 16, .rs = 16, .cs = 1,
   .rs0 = 1, .cs0 = 16, .rs1 = 256, .cs1 = 256},
  {TEST, .m = 32, .n = 8, .m0 = 8, .n0 = 8, .rs = 8, .cs = 1,
  ...
  {TEST, .m = 128, .n = 128, .m0 = 8, .n0 = 8, .rs = 128, .cs = 1,
   .rs0 = 1, .cs0 = 8, .rs1 = 1024, .cs1 = 64},

  {TEST, .m = 300, .n = 200, .m0 = 64, .n0 = 16, .rs = 200, .cs = 1,
  ...
  {TEST, .m = 300, .n = 200, .m0 = 64, .n0 = 16, .rs = 1, .cs = 300,
   .rs0 = 16, .cs0 = 1, .rs1 = 13312, .cs1 = 1024},
  {TEST, .m = 300, .n = 200, .m0 = 64, .n0 = 16, .rs = 1, .cs = 300,
   .rs0 = 16, .cs0 = 1, .rs1 = 1024, .cs1 = 5120},
  {TEST, .m = 300, .n = 200, .m0 = 64, .n0 = 16, .rs = 1, .cs = 300,
