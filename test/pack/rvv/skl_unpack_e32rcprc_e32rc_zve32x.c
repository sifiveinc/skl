...
#include "pack/unpack_e32rcprc_e32rc.h"
 ...
 *
 * This test uses the unpack_e32rcprc_e32rc harness.
 */
...
static skl_test_suite_t suite = {.name = "skl_unpack_e32rcprc_e32rc_zve32x",
                                 .num_tests = sizeof(tests) / sizeof(tests[0]),
                                 .test_size = sizeof(unpack_e32rcprc_e32rc_t),
                                 .tests = tests};
