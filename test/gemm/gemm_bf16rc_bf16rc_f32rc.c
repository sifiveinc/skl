...
void skl_gemm_a1b01_bf16c_bf16_f32_xsfmm32a16f_wrapper(
    size_t m, size_t n, size_t k, float alpha, const __bf16 *a, size_t rsa,
    size_t csa, const __bf16 *b, size_t rsb, size_t csb, float beta, float *c,
  ...
  skl_gemm_a1b01_bf16c_bf16_f32_xsfmm32a16f(m, n, k, a, csa, b, rsb, c, rsc,
                                            beta != 0.f);
}
#endif
...
int check_error(void) {
  ...
  skl_gemm_bf16rc_bf16rc_f32rc_scalar(M, N, K, ALPHA, a, RSA, CSA, b, RSB, CSB,
                                      BETA, ref_c, RSC, CSC);
