...
gemm_i8rcprc_i8rcprc_i32rcprc_t tests[] = {
    ...
    // Verification tests
    {TEST, .m1 = 0, .n1 = 0,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 0, .n1 = 1,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 0,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 8,  .k1 = 0,  .alpha = 1},
    {TEST, .m1 = 2, .n1 = 8,  .k1 = 0,  .alpha = 1},

    {TEST, .m1 = 1, .n1 = 1,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 2,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 3,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 4,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 5,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 6,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 7,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 8,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 1, .n1 = 15, .k1 = 67, .alpha = 1},

    {TEST, .m1 = 2, .n1 = 1,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 2,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 3,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 4,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 5,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 6,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 7,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 8,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 2, .n1 = 15, .k1 = 67, .alpha = 1},

    {TEST, .m1 = 3, .n1 = 1,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 2,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 3,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 4,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 5,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 6,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 7,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 8,  .k1 = 67, .alpha = 1},
    {TEST, .m1 = 3, .n1 = 15, .k1 = 67, .alpha = 1},

    {TEST, .m1 = 65, .n1 = 65, .k1 = 255, .alpha = 1},
