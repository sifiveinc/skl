...
/**
 * @brief Implementation of the gemm_f16rcprc_f16rcprc_f32rcprc test harness.
 *
 * This file defines all harness functions _except_ `skl_test_execute`, which is
 * defined in the test file (e.g. rvv/skl_gemm_f16_f16_f32_zve32f_x390.c).
 */

#include "gemm_f16rcprc_f16rcprc_f32rcprc.h"
#include "skl-ref.h"
...
void gemm_f16rcprc_f16rcprc_f32rcprc_verify(skl_test_t *t) {
  ...
  //
  // Note: ref_c contains the original C values (copied in
  ...
  // Compute the reference result using ref_c
  // ref_c contains the original C values (copied in skl_test_init)
...
void gemm_f16rcprc_f16rcprc_f32rcprc_test_report(skl_test_t *t) {
  gemm_f16rcprc_f16rcprc_f32rcprc_t *h =
      (gemm_f16rcprc_f16rcprc_f32rcprc_t *)t->harness;
...
void gemm_f16rcprc_f16rcprc_f32rcprc_benchmark_report(skl_test_t *t) {
  gemm_f16rcprc_f16rcprc_f32rcprc_t *h =
      (gemm_f16rcprc_f16rcprc_f32rcprc_t *)t->harness;

  gemm_f16rcprc_f16rcprc_f32rcprc_test_report(t);
