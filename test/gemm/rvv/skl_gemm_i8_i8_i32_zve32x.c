...
/**
 * @brief Test cases for the skl_gemm_i8_i8_i32_zve32x kernel.
 *
...
static skl_test_suite_t suite = {.name = "skl_gemm_i8_i8_i32_zve32x",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_i8_i8_i32_zve32x(h->m1, h->n1, h->k1, h->alpha, h->a.data, h->rsa1,
