...
#include "gemm/gemm_f64rcprc_f64rcprc_f64rcprc.h"
...
/**
 * @brief Test cases for the skl_gemm_f64_f64_f64_zve64d_x390 kernel.
 *
 * This test uses the gemm_f64rcprc_f64rcprc_f64rcprc harness with the following
...
#define TEST                                                                   \
  GEMM_F64RCPRC_F64RCPRC_F64RCPRC_DEFAULTS,                                    \
      .steps = {                                                               \
          .init = init,                                                        \
          .warmup = NULL,                                                      \
          .execute = execute,                                                  \
          .verify = gemm_f64rcprc_f64rcprc_f64rcprc_verify,                    \
          .report = gemm_f64rcprc_f64rcprc_f64rcprc_test_report,               \
          .cleanup = gemm_f64rcprc_f64rcprc_f64rcprc_cleanup,                  \
  }
...
#define BENCH                                                                  \
  GEMM_F64RCPRC_F64RCPRC_F64RCPRC_DEFAULTS,                                    \
      .steps = {                                                               \
          ...
          .execute = execute,                                                  \
          .verify = NULL,                                                      \
          .report = gemm_f64rcprc_f64rcprc_f64rcprc_benchmark_report,          \
          .cleanup = gemm_f64rcprc_f64rcprc_f64rcprc_cleanup,                  \
  }
...
// clang-format off
gemm_f64rcprc_f64rcprc_f64rcprc_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
    // Benchmark tests
    {BENCH, .m1 =  64, .n1 = 128, .k1 = 128, .alpha = 1.0},
#endif // SKL_ENABLE_BENCHMARKS

#ifdef SKL_ENABLE_TESTS
    // Verification tests - comprehensive coverage for RVV GEMM
    /* Edge cases: minimal dimensions */
    {TEST, .m1 = 1,   .n1 = 1,   .k1 = 0,  .alpha = 2.0},
    {TEST, .m1 = 1,   .n1 = 1,   .k1 = 1,  .alpha = 2.0},

    /* Small odd dimensions for remainder handling */
    {TEST, .m1 = 7,   .n1 = 7,   .k1 = 7,  .alpha = 2.0},
    {TEST, .m1 = 17,  .n1 = 17,  .k1 = 17, .alpha = 2.0},

    /* Skinny matrices (one dimension = 1) */
    {TEST, .m1 = 1,   .n1 = 33,  .k1 = 31, .alpha = 2.0},
    {TEST, .m1 = 33,  .n1 = 1,   .k1 = 31, .alpha = 2.0},

    /* k=0 edge case (C = beta*C, no A*B contribution) */
    {TEST, .m1 = 33,  .n1 = 33,  .k1 = 0,  .alpha = 2.0},
    {TEST, .m1 = 16,  .n1 = 16,  .k1 = 0,  .alpha = 2.0,  .beta = 3.0},

    /* Vector length boundary tests (multiples of 4, 8, 16, 32) */
    {TEST, .m1 = 16,  .n1 =  64, .k1 = 16, .alpha = 2.0},
    {TEST, .m1 = 32,  .n1 = 128, .k1 = 32, .alpha = 2.0},

    /* Near-boundary tests (±1 from vector length multiples) */
    {TEST, .m1 = 15,  .n1 = 63,  .k1 = 31, .alpha = 2.0},
    {TEST, .m1 = 31,  .n1 = 65,  .k1 = 15, .alpha = 2.0},

    /* Wide and tall matrices */
    {TEST, .m1 = 33,  .n1 = 129, .k1 = 32, .alpha = 2.0},
    {TEST, .m1 = 129, .n1 = 33,  .k1 = 32, .alpha = 2.0},
    {TEST, .m1 = 31,  .n1 = 133, .k1 = 32, .alpha = 2.0},

    /* Beta scaling test */
    {TEST, .m1 = 32,  .n1 = 32,  .k1 = 32, .alpha = 2.0,  .beta = 3.0},
#endif // SKL_ENABLE_TESTS
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_gemm_f64_f64_f64_zve64d_x390",
                                 .num_tests = sizeof(tests) / sizeof(tests[0]),
                                 .test_size =
                                     sizeof(gemm_f64rcprc_f64rcprc_f64rcprc_t),
                                 .tests = tests};
...
static void init(skl_test_t *t) {
  ...
  gemm_f64rcprc_f64rcprc_f64rcprc_init(t);
}
