...
/**
 * @brief Test cases for the skl_gemm_f16_f16_f32_zvfh kernel.
 *
...
static skl_test_suite_t suite = {.name = "skl_gemm_f16_f16_f32_zvfh",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_f16_f16_f32_zvfh(h->m1, h->n1, h->k1, h->alpha, h->a.data, h->rsa1,
