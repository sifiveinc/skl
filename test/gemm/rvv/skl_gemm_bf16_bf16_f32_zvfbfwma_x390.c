...
/**
 * @brief Test cases for the skl_gemm_bf16_bf16_f32_zvfbfwma_x390 kernel.
 *
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_bf16_bf16_f32_zvfbfwma_x390",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_bf16_bf16_f32_zvfbfwma_x390(h->m1, h->n1, h->k1, h->alpha, h->a.data,
