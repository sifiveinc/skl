...
/**
 * @brief Test cases for the skl_gemm_i8_i8_i32_zve32x_x390 kernel.
 *
...
gemm_i8rcprc_i8rcprc_i32rcprc_t tests[] = {
    ...
    // Benchmark tests
    {BENCH, .m1 =  64, .n1 = 128, .k1 = 128, .alpha = 1},
    ...
    {TEST, .m1 = 7,   .n1 = 7,   .k1 = 7,  .alpha = 1},
    {TEST, .m1 = 17,  .n1 = 17,  .k1 = 17, .alpha = 1},
    /* Skinny matrices (one dimension = 1) */
    {TEST, .m1 = 1,   .n1 = 33,  .k1 = 31, .alpha = 1},
    {TEST, .m1 = 33,  .n1 = 1,   .k1 = 31, .alpha = 1},
    /* k=0 edge case (C = beta*C, no A*B contribution) */
    {TEST, .m1 = 33,  .n1 = 33,  .k1 = 0,  .alpha = 1},
    {TEST, .m1 = 16,  .n1 = 16,  .k1 = 0,  .alpha = 1,  .beta = 1},
    /* Vector length boundary tests (multiples of 4, 8, 16, 32) */
    {TEST, .m1 = 16,  .n1 = 16,  .k1 = 16, .alpha = 1},
    {TEST, .m1 = 32,  .n1 = 32,  .k1 = 32, .alpha = 1},
    /* Near-boundary tests (±1 from vector length multiples) */
    {TEST, .m1 = 15,  .n1 = 17,  .k1 = 31, .alpha = 1},
    {TEST, .m1 = 31,  .n1 = 33,  .k1 = 15, .alpha = 1},
    /* Wide and tall matrices */
    {TEST, .m1 = 33,  .n1 = 129, .k1 = 32, .alpha = 1},
    {TEST, .m1 = 129, .n1 = 33,  .k1 = 32, .alpha = 1},
    {TEST, .m1 = 31,  .n1 = 133, .k1 = 32, .alpha = 1},
    /* Beta scaling test (beta=1, accumulate into existing C) */
    {TEST, .m1 = 32,  .n1 = 32,  .k1 = 32, .alpha = 1,  .beta = 1},
#endif // SKL_ENABLE_TESTS
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_gemm_i8_i8_i32_zve32x_x390",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_i8_i8_i32_zve32x_x390(h->m1, h->n1, h->k1, h->alpha, h->a.data,
