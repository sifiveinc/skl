 ...
 *
 * This test uses the gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc harness with the
...
#define TEST                                                                   \
  GEMM_F8E5M2RCPRC_F8E5M2RCPRC_F32RCPRC_DEFAULTS,                              \
      .steps = {                                                               \
          ...
          .warmup = NULL,                                                      \
          .execute = execute,                                                  \
          .verify = gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_verify,              \
          .report = gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_test_report,         \
          .cleanup = gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_cleanup,            \
  }
...
#define BENCH                                                                  \
  GEMM_F8E5M2RCPRC_F8E5M2RCPRC_F32RCPRC_DEFAULTS,                              \
      .steps = {                                                               \
          ...
          .execute = execute,                                                  \
          .verify = NULL,                                                      \
          .report = gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_benchmark_report,    \
          .cleanup = gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_cleanup,            \
  }
...
// clang-format off
gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
    // Benchmark tests
    {BENCH, .m1 = 128, .n1 = 128, .k1 = 8192, .alpha = 1.f, .beta = 0.f},
    {BENCH, .m1 = 128, .n1 = 128, .k1 = 8192, .alpha = 1.f, .beta = 1.f},
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_a1b01_f8e5m2c_f8e5m2_f32_xsfmm32a8f",
    .num_tests = sizeof(tests) / sizeof(tests[0]),
    .test_size = sizeof(gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_t),
    .tests = tests};

static void init(skl_test_t *t) {
  const gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_t *h =
  ...
  gemm_f8e5m2rcprc_f8e5m2rcprc_f32rcprc_init(t);
}
