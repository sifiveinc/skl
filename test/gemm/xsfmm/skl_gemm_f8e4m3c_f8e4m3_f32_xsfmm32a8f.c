...
/**
 * @brief Test cases for the skl_gemm_f8e4m3c_f8e4m3_f32_xsfmm32a8f kernel.
 *
...
#define TEST                                                                   \
  GEMM_F8E4M3RCPRC_F8E4M3RCPRC_F32RCPRC_DEFAULTS,                              \
      .steps = {                                                               \
          .init = init,                                                        \
          .warmup = NULL,                                                      \
          .execute = execute,                                                  \
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_f8e4m3c_f8e4m3_f32_xsfmm32a8f",
