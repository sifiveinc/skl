 ...
 * skl_gemm_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i kernel.
 *
...
gemm_i8rcprc_i8rcprc_i32rcprc_t tests[] = {
    ...
    {TEST, .m1 = 7, .n1 = 1, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 2, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 3, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 4, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 5, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 6, .k1 = 15, .alpha = 2, .beta = 3},
    {TEST, .m1 = 7, .n1 = 7, .k1 = 15, .alpha = 2, .beta = 3},

    {TEST, .m1 = 7, .n1 = 7, .k1 = 15, .alpha = 2, .beta = 3, .csc0 = 2},
    {TEST, .m1 = 7, .n1 = 7, .k1 = 15, .alpha = 2, .beta = 3, .rsc0 = 1,
           .csc0 = SKL_XSFMM_TE},
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_i8rcptex1c_i8rcp1xte_i32rcptexterc_xsfmm32a8i(
