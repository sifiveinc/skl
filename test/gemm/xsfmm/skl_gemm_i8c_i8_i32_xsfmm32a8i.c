...
gemm_i8rcprc_i8rcprc_i32rcprc_t tests[] = {
    ...
    // Verification tests - comprehensive coverage for Xsfmm layout (ETE=64)
    ...
    {TEST, .m1 = 65,  .n1 = 65,  .k1 = 0,  .alpha = 2, .beta = 3},
    {TEST, .m1 = 65,  .n1 = 65,  .k1 = 1,  .alpha = 2, .beta = 3},
    {TEST, .m1 = 65,  .n1 = 65,  .k1 = 33, .alpha = 2, .beta = 3},
    {TEST, .m1 = 128, .n1 = 128, .k1 = 33, .alpha = 2, .beta = 3},
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_i8c_i8_i32_xsfmm32a8i(h->m1, h->n1, h->k1, h->alpha, h->a_pack.data,
                                 h->csa1, h->b_pack.data, h->rsb1, h->beta,
