...
/**
 * @brief Test cases for the skl_gemm_f8e5m2c_f8e5m2_f32_xsfmm32a8f kernel.
 *
...
gemm_f8rcprc_f8rcprc_f32rcprc_t tests[] = {
    ...
    // Benchmark tests
    {BENCH, .m1 = 2 * SKL_XSFMM_TE, .n1 = 2 * SKL_XSFMM_TE, .k1 = 8192, .alpha = 1.f, .beta = 0.f},
    {BENCH, .m1 = 2 * SKL_XSFMM_TE, .n1 = 2 * SKL_XSFMM_TE, .k1 = 8192, .alpha = 1.f, .beta = 1.f},
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_f8e5m2c_f8e5m2_f32_xsfmm32a8f",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_f8e5m2c_f8e5m2_f32_xsfmm32a8f(h->m1, h->n1, h->k1, h->alpha,
