...
/**
 * @brief Test cases for the skl_gemm_bf16c_bf16_f32_xsfmm32a16f kernel.
 *
...
static skl_test_suite_t suite = {
    .name = "skl_gemm_bf16c_bf16_f32_xsfmm32a16f",
...
static void execute(skl_test_t *t) {
  ...
  skl_gemm_bf16c_bf16_f32_xsfmm32a16f(h->m1, h->n1, h->k1, h->alpha, h->a.data,
