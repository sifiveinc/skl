...
/**
 * @brief Consolidated FP16 sigmoid-family test cases for zvfh.
 *
...
unary_f16_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_logistic_f16_zvfh, -1, 1),
    FUNCTION_BENCHMARKS(skl_silu_f16_zvfh, -1, 1),
    FUNCTION_BENCHMARKS(test_swish_f16_zvfh, -1, 1),
    FUNCTION_BENCHMARKS(test_glu_f16_zvfh, -1, 1),
    FUNCTION_BENCHMARKS(test_swiglu_f16_zvfh, -1, 1),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_logistic_f16_zvfh, skl_logistic_f16_ref, LOGISTIC_MIN,
                   LOGISTIC_MAX, 3.0f),
    FUNCTION_TESTS(skl_silu_f16_zvfh, skl_silu_f16_ref, SILU_MIN, SILU_MAX,
                   9.0f),
    FUNCTION_TESTS(test_swish_f16_zvfh, ref_swish_f16, SWISH_MIN, SWISH_MAX,
                   9.0f),
    FUNCTION_TESTS(test_glu_f16_zvfh, ref_glu_f16, GLU_MIN, GLU_MAX, 9.0f),
    FUNCTION_TESTS(test_swiglu_f16_zvfh, ref_swiglu_f16, SWIGLU_MIN, SWIGLU_MAX,
                   9.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_sigmoid_f16_zvfh",
