...
unary_bf16_t tests[] = {
    ...
    FUNCTION_TESTS(skl_silu_bf16_zve32f, skl_silu_bf16_ref, SILU_MIN, SILU_MAX,
                   2.0f),
    FUNCTION_TESTS(test_swish_b1_bf16_zve32f, ref_swish_b1_bf16, SWISH_MIN,
                   SWISH_MAX, 2.0f),
    FUNCTION_TESTS(test_swish_bp_bf16_zve32f, ref_swish_bp_bf16, SWISH_MIN,
                   SWISH_MAX, 2.0f),
    FUNCTION_TESTS(test_swish_bn_bf16_zve32f, ref_swish_bn_bf16, SWISH_MIN,
                   SWISH_MAX, 2.0f),
