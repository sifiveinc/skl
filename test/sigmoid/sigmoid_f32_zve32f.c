...
unary_f32_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_logistic_f32_zve32f, -1, 1),
    FUNCTION_BENCHMARKS(skl_silu_f32_zve32f, -1, 1),
    FUNCTION_BENCHMARKS(test_swish_f32_zve32f, -1, 1),
    FUNCTION_BENCHMARKS(test_glu_f32_zve32f, -1, 1),
    FUNCTION_BENCHMARKS(test_swiglu_f32_zve32f, -1, 1),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_logistic_f32_zve32f, skl_logistic_f32_ref, LOGISTIC_MIN,
                   LOGISTIC_MAX, 3.0f),
    FUNCTION_TESTS(skl_silu_f32_zve32f, skl_silu_f32_ref, SILU_MIN, SILU_MAX,
                   52.0f),
    FUNCTION_TESTS(test_swish_f32_zve32f, ref_swish_f32, SWISH_MIN, SWISH_MAX,
                   52.0f),
    FUNCTION_TESTS(test_glu_f32_zve32f, ref_glu_f32, GLU_MIN, GLU_MAX, 52.0f),
    FUNCTION_TESTS(test_swiglu_f32_zve32f, ref_swiglu_f32, SWIGLU_MIN,
                   SWIGLU_MAX, 52.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_sigmoid_f32_zve32f",
