...
/**
 * @brief Test cases for 1D BF16 Softmax with Xsfvfexpa and Zvfbfmin extensions
 */

// clang-format off
softmax_bf16_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
  VARIANT_BENCHMARKS(xsfvfexpa_zvfbfmin),
#endif
#ifdef SKL_ENABLE_TESTS
  VARIANT_TESTS(xsfvfexpa_zvfbfmin),
#endif
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_softmax_bf16_xsfvfexpa_zvfbfmin",
