...
/**
 * @brief Test cases for 1D BF16 Softmax with Xsfvfexpa and Xsfvfbfa extensions
 */

// clang-format off
softmax_bf16_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
  VARIANT_BENCHMARKS(xsfvfexpa_xsfvfbfa),
#endif
#ifdef SKL_ENABLE_TESTS
  VARIANT_TESTS(xsfvfexpa_xsfvfbfa),
#endif
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_softmax_bf16_xsfvfexpa_xsfvfbfa",
