...
/**
 * @brief Test cases for 1D Softmax with Xsfvfexpa and Zvfh extensions
 */

// clang-format off
softmax_f16_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
  VARIANT_BENCHMARKS(xsfvfexpa_zvfh),
#endif
#ifdef SKL_ENABLE_TESTS
  VARIANT_TESTS(xsfvfexpa_zvfh),
#endif
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_softmax_f16_xsfvfexpa_zvfh",
