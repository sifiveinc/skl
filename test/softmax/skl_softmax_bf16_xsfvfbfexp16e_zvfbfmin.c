...
/**
 * @brief Test cases for 1D BF16 Softmax with Xsfvfbfexp16e and Zvfbfmin
 * extensions
 */
...
softmax_bf16_t tests[] = {
  ...
  VARIANT_BENCHMARKS(xsfvfbfexp16e_zvfbfmin),
#endif
#ifdef SKL_ENABLE_TESTS
  VARIANT_TESTS(xsfvfbfexp16e_zvfbfmin),
#endif
};
// clang-format on

static skl_test_suite_t suite = {.name =
                                     "skl_softmax_bf16_xsfvfbfexp16e_zvfbfmin",
