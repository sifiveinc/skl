...
/**
 * @brief Test cases for 1D Softmax with Xsfvfexp16e extension
 */

// clang-format off
softmax_f16_t tests[] = {
#ifdef SKL_ENABLE_BENCHMARKS
  VARIANT_BENCHMARKS(xsfvfexp16e),
#endif
#ifdef SKL_ENABLE_TESTS
  VARIANT_TESTS(xsfvfexp16e),
#endif
};
// clang-format on

static skl_test_suite_t suite = {.name = "skl_softmax_f16_xsfvfexp16e",
