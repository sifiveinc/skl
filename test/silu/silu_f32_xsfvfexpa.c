...
/**
 * @brief Test cases for FP32 SiLU with Xsfvfexpa extension.
 *
...
unary_f32_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_silu_52u_f32_xsfvfexpa, -1, 1),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_silu_52u_f32_xsfvfexpa, skl_silu_1u_f32_ref, MIN, MAX, 52.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_silu_f32_xsfvfexpa",
