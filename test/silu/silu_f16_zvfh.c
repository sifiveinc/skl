...
/**
 * @brief Test cases for FP16 SiLU with Zvfh extension.
 *
...
unary_f16_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_silu_9u_f16_zvfh, -1, 1),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_silu_9u_f16_zvfh, skl_silu_1u_f16_ref, MIN, MAX, 9.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_silu_f16_zvfh",
