...
/**
 * @brief Test cases for BF16 Logistic with Xsfvfbfa extension.
 */
...
unary_bf16_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_logistic_3u_bf16_xsfvfbfa, -1, 1),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_logistic_3u_bf16_xsfvfbfa, skl_logistic_1u_bf16_ref, MIN, MAX, 3.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_logistic_bf16_xsfvfbfa",
