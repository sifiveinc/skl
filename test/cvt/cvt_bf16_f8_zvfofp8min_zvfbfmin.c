...
#define TEST_BF16_F8E4M3                                                       \
  CVT_BF16_F8_DEFAULTS, .out_type = F8E4M3, .saturation = false,               \
      .steps = {                                                               \
...
#define TEST_SAT_BF16_F8E4M3                                                   \
  CVT_BF16_F8_DEFAULTS, .out_type = F8E4M3, .saturation = true,                \
      .steps = {                                                               \
          .init = cvt_bf16_f8_init,                                            \
          .warmup = NULL,                                                      \
...
#define TEST_SAT_BF16_F8E5M2                                                   \
  CVT_BF16_F8_DEFAULTS, .out_type = F8E5M2, .saturation = true,                \
      .steps = {                                                               \
          .init = cvt_bf16_f8_init,                                            \
          .warmup = NULL,                                                      \
...
static skl_test_suite_t suite = {.name = "cvt_bf16_f8_zvfofp8min_zvfbfmin",
