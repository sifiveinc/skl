...
/**
 * @brief Test cases for BF16 Exponential with Zve32f extension.
 *
...
unary_bf16_t tests[] = {
    ...
    FUNCTION_BENCHMARKS(skl_exp_1u_bf16_zve32f, MIN, MAX),
#endif
#if defined(SKL_ENABLE_TESTS)
    FUNCTION_TESTS(skl_exp_1u_bf16_zve32f, skl_exp_bf16_ref, MIN, MAX, 1.0f),
#endif
};

static skl_test_suite_t suite = {.name = "skl_exp_bf16_zve32f",
