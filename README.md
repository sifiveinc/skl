...
For projects that support CMake version 3.23 or higher, SKL provides a basic CMake-based build system that can be used to produce a static library `libskl.a` as a library dependency.
